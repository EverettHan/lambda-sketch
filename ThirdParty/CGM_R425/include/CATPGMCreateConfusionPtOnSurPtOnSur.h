#ifndef CATIPGMCreateConfusionPtOnSurPtOnSur_h_
#define CATIPGMCreateConfusionPtOnSurPtOnSur_h_
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMConfusionPtOnSurPtOnSur *CATPGMCreateConfusion(
...
#endif /* CATIPGMCreateConfusionPtOnSurPtOnSur_h_ */
