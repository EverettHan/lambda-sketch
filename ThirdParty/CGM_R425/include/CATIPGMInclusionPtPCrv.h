#ifndef CATIPGMInclusionPtPCrv_h_
#define CATIPGMInclusionPtPCrv_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMInclusionPtPCrv;
 ...
 *<ul>
 *<li>The CATIPGMInclusionPtPCrv operator is created with the @href CreateInclusionMinPtPCrv method.
 ...
 *</ul>
 */
class ExportedByCATGMModelInterfaces CATIPGMInclusionPtPCrv: public CATIPGMOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMInclusionPtPCrv();
 ...
 */
  ...
  /**
 * Returns the number of points resulting of <tt>this</tt> CATIPGMInclusionPtCrv operator.
 * @return
 ...
 * CATIPGMInclusionPtPCrv operator.
 ...
 */
  ...
  /**
 * Skips to the next solution point of <tt>this</tt> CATIPGMInclusionPtPCrv operator.
 ...
 */
  ...
  /**
 * Returns the next solution point of <tt>this</tt> CATIPGMInclusionPtPCrv operator.
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMInclusionPtPCrv(); // -> delete can't be called
};

#endif /* CATIPGMInclusionPtPCrv_h_ */
