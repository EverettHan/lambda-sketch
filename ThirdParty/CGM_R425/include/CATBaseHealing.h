#ifndef CATBaseHealing_H
#define CATBaseHealing_H
//
...
class ExportedByRibbon CATBaseHealing	: public	CATTopOperator
{
  CATCGMVirtualDeclareClass(CATBaseHealing);
  public:
 ...
 */
  virtual	int SetFace(CATFace * iF, const CATBoolean iIsGeomFree, const CATBoolean iIsTypeFree) = 0;
 ...
 * cannot become a Nurbs surface), <tt>TRUE</tt>
 */
	virtual	int SetFace(const ListPOfCATFace &iListOfFaces, const CATBoolean iIsGeomFree, const CATBoolean iIsTypeFree) = 0;
 ...
 * cannot become a Nurbs surface), <tt>TRUE</tt>
 */
  virtual	int SetFace(const CATGeometricType iType, const CATBoolean iIsGeomFree, const CATBoolean iIsTypeFree) = 0;
 ...
 * <tt>1</tt> for a G1 continuity.
 */  
  virtual int SetEdge(const ListPOfCATEdge &iListOfEdges , const short iOrder) = 0;	
 ...
 */
  CATBaseHealing(CATGeoFactory * iGeoFactory, CATTopData * iTopData);
