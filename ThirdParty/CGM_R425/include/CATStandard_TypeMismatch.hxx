...
//
#ifndef _CATStandard_TypeMismatch_HeaderFile
#define _CATStandard_TypeMismatch_HeaderFile
...
#if !defined No_Exception && !defined No_CATStandard_TypeMismatch
#define CATStandard_TypeMismatch_Raise_if(CONDITION,MESSAGE) \
  if (CONDITION) CATStandard_TypeMismatch::Raise(MESSAGE);
#else
#define CATStandard_TypeMismatch_Raise_if(CONDITION,MESSAGE)
#endif
...
class CATStandard_TypeMismatch : public CATStandard_DomainError {
/*
public:
 ...
 ExportedBySysCascade  ~CATStandard_TypeMismatch();

 // Type methods
 //
 ExportedBySysCascade  friend Handle_CATStandard_Type& CATStandard_TypeMismatch_Type_();
