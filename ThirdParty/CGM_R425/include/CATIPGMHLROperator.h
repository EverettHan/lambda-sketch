#ifndef CATIPGMHLROperator_h_
#define CATIPGMHLROperator_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMHLROperator;
 ...
 * <ul>
 *     <li> A <tt>CATIPGMHLROperator</tt> operator is created with the <tt>CATPGMCreateHLROperator</tt> global functions.
 *     <li> It is the user's responsibility to release the operator after it has been used.
 * </ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMHLROperator: public CATIPGMOperator
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMHLROperator(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMHLROperator *CATPGMCreateHLROperator(
 ...
 * The pointer to the factory to contain the output geometry.
 * @param iProjectionPlane
 * The pointer to the <tt>CATMathPlane</tt> in order to define the first/single view direction and the projection support.
 * The projection plane must belong to the input factory.
 * @return
 * The pointer to the created operator. To be released with the <tt>Release</tt> method after use.
 */
ExportedByCATGMOperatorsInterfaces CATIPGMHLROperator *CATPGMCreateHLROperator(
