#ifndef CATIPGMTopoDeformSwitchGeometry_h_
#define CATIPGMTopoDeformSwitchGeometry_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopoDeformSwitchGeometry;
 ...
 *<ul>
 * <li>A CATIPGMTopoDeformSwitchGeometry operator is created with the <tt>CATPGMCreateTopoDeformSwitchGeometry</tt> global method:
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopoDeformSwitchGeometry: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopoDeformSwitchGeometry();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopoDeformSwitchGeometry(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopoDeformSwitchGeometry *CATPGMCreateTopoDeformSwitchGeometry(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToBeDeformed);

#endif /* CATIPGMTopoDeformSwitchGeometry_h_ */
