#ifndef CATIPGMTopSplitShellByWires_h_
#define CATIPGMTopSplitShellByWires_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopSplitShellByWires;
 ...
 *<ul>
 * <li>Create it with the <tt>CATPGMCreateSplitShellByWiresBasicExtrapol</tt> global function.
 ...
 *</ul> 
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopSplitShellByWires: public CATIPGMTopOperator
{
public:
  /**
  * Constructor
  */
  CATIPGMTopSplitShellByWires();
  ...
  * Do not use.
  */
  virtual void SetExtrapolTool(CATIPGMExtrapolTool *iExtrap) = 0;
  ...
  */
  virtual void GetResultBodies(
    CATLISTP(CATBody) &ioResultBodies,
    CATLISTP(ListPOfCATEdge)*EdgesNonDiconectintgResultBodies = NULL) = 0;
  ...
  */
  virtual void GetBoundaryComposition(
    CATBody *iBody,
    CATLISTP(CATWire) &iInitialWires,
    int **ioNbEdgesPerWire,
    CATEdge **** ioBoundaries) = 0;
  ...
  * The array of array of edges bounding iBody on the corresponding wire.
  */
  virtual void IsBoundaryOf(
    CATWire *iWire,
    CATLISTP(CATBody) &ioBoundedBodies,
    int **ioNbEdgesPerBody,
    CATEdge **** ioBoundaries) = 0;
  ...
  */
  virtual void GetBodiesBoundedByAllWires(
    CATLISTP(CATBody) &ioBoundedBodies,
    CATBoolean iInitialBoundaryAuthorised = FALSE) = 0;
  ...
  /**
      ...
      */
  virtual void SetStopExtrapolationsAtFirstIntersection(
    CATBoolean iStopExtrapolationsAtFirstIntersection) = 0;
  ...
  /**
      ...
      */
  virtual void SetComputeShellWireInclusion(
    CATBoolean iComputeShellWireInclusion) = 0;
  ...
  /**
      ...
      */
  virtual void RetrieveShellWireInclusion(
    CATBody *iOneResultBody,
    CATListOfInt &ioWirePositionsInInputList) = 0;
  ...
  /**
      ...
      */
  virtual void IsBoundaryOf(
    CATBody *iInitialWireBody,
    int iSide,
    CATLISTP(CATShell) &ioBoundedShells) = 0;
  ...
  /**
      ...
      */
  virtual void SetWiresAlreadyExtrapolated(
    CATWire *iWireBeforeExtrapolation,
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopSplitShellByWires(); // -> delete can't be called
};

#endif /* CATIPGMTopSplitShellByWires_h_ */
