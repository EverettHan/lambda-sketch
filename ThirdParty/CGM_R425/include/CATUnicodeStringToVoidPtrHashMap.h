...
#ifndef CATSysTSUnicodeStringToVoidPtr_h
#define CATSysTSUnicodeStringToVoidPtr_h
...
#define CATSYSTS_CTNR                  CATUnicodeStringToVoidPtrHashMap

#define CATSYSTS_KEY                   CATUnicodeString
