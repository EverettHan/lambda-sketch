...
#ifndef CATPLMMLEngineFactorySimpleRestricted_H
#define CATPLMMLEngineFactorySimpleRestricted_H
...
class CATIPLMMLEngineSimpleRestricted_var;

class ExportedByCATPLMModelerLanguage CATPLMMLEngineFactorySimpleRestricted
{
public:
  static HRESULT Create(CATIPLMMLEngineSimpleRestricted_var& ospEngine);
