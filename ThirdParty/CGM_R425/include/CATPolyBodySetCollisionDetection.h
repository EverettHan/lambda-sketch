...
//===================================================================
//
// CATPolyBodySetCollisionDetection.h
//
//===================================================================
//
// Usage notes:
...
//
// 2010-04-23 XXC: New
// 2010-10-15 XXC: Updated to manage all the objects and to determine
// which object couples are potentially colliding at each frame.
//===================================================================

#ifndef CATPolyBodySetCollisionDetection_h
#define CATPolyBodySetCollisionDetection_h
...
// Interference
#include "CATPolyInterfCollisionOper.h"
 ...
 */
class ExportedByCATPolyBoundingVolumeOperators CATPolyBodySetCollisionDetection
{
public:
   ...
   */
  CATPolyBodySetCollisionDetection(const CATTolerance & iTol = CATGetDefaultTolerance());
  CATPolyBodySetCollisionDetection(CATBVHTreeSet & ioObjectSet, const CATTolerance & iTol = CATGetDefaultTolerance());
  ~CATPolyBodySetCollisionDetection();
...
private:
  ...
  CATPolyInterfCollisionOper _Operator;

  CATPolyCollisionInterfList * _ResultList;
};

#endif /* CATPolyBodySetCollisionDetection_h */
