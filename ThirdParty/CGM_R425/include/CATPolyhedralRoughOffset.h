/* -*-C++-*-*/
#ifndef CATPolyhedralRoughOffset_H
#define CATPolyhedralRoughOffset_H

//=============================================================================
//
// COPYRIGHT : DASSAULT SYSTEMES 2019
//
// CATPolyhedralRoughOffset
//
// DESCRIPTION :
// Operator that offsets a polyhedral body.
//
//
// History
//
// April. 2019 DPS/H7W/RBU3 Creation
//=============================================================================
...
* </ul>
*/
class ExportedByGMPolyOffset CATPolyhedralRoughOffset : public CATGMPolyTopOperator
{
  CATCGMVirtualDeclareClass(CATPolyhedralRoughOffset);
...
public:
  ...
  * Destructor
  */
  virtual ~CATPolyhedralRoughOffset();
  ...
  *   the output volume will be bounded by the offset envelope of the input skin,
  *   applying the offset both sides and around the skin boundaries
  *   the sign of the offset value doesn't matter in this case and will be ignored
  */
  ...
  */
  virtual HRESULT GetAccuracyFromDeviation(double iMaxDeviation, int &oAccuracyToUse, int &oErroryType) = 0;
  ...
  */
  virtual HRESULT GetMaxDeviation(double & oMaxDeviation, int * ioComputedAccuracyLevel123=0) = 0;
...
protected:
  ...
  */
  CATPolyhedralRoughOffset(CATGeoFactory & iFactory, const CATTopData & iTopData, CATGMPolyOperTopExt &iExtensible);
...
private:
  ...
  CATPolyhedralRoughOffset();
  CATPolyhedralRoughOffset(const CATPolyhedralRoughOffset& iOneOf);
  CATPolyhedralRoughOffset& operator =(const CATPolyhedralRoughOffset& iOneOf);
};


/**
 * Creates a CATPolyhedralRoughOffset operator
 * @param iFactory
 ...
 */
ExportedByGMPolyOffset CATPolyhedralRoughOffset * CATCreatePolyhedralRoughOffset(CATGeoFactory * iFactory, CATTopData * iTopData, CATBody * iBodyToOffset);

#endif /* CATPolyhedralRoughOffset_H */
