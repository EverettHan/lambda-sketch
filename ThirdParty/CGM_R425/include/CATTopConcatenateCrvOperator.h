#ifndef CATTopConcatenateCrvOperator_h
#define CATTopConcatenateCrvOperator_h
 ...
 * <ul>
 *<li> Create the operator with the global function <tt>CATCreateTopConcatenateCrvOperator</tt>, which defines
...
class ExportedByBasicTopology CATTopConcatenateCrvOperator : public CATTopOperator
{
  
  //-------------------------------------------------------------------
  CATCGMVirtualDeclareClass(CATTopConcatenateCrvOperator);
public:
  //-------------------------------------------------------------------

  /**
  * @nodoc
  * Constructor. Do not use. Use <tt>CATCreateTopConcatenateCrvOperator</tt> to create an
  * <tt>CATTopConcatenateCrvOperator</tt>.
  */
  CATTopConcatenateCrvOperator(CATGeoFactory * iFactory, CATTopData* iTopData);

  virtual ~CATTopConcatenateCrvOperator();

  //
  // ADVANCED mode settings
  //-----------------------
  //
  // The following setting methods follow the creation of a CATTopConcatenateCrvOperator,
  // (see CATCreateTopConcatenateCrvOperator global function)
  //
  ...
  */
  virtual CATCell* GetDescendant(CATCell * iCell);
...
*/
ExportedByBasicTopology CATTopConcatenateCrvOperator * 
CATCreateTopConcatenateCrvOperator(CATGeoFactory     * iFactory,
                                   CATTopData        * iTopData,
                                   CATBody           * iWireBody);
