...
//
// Methode permettant la creation d'une instance de l'operateur de split d'un
// body solide par un body surfacique.
//=============================================================================

#ifndef __CATCreateSplitBySkin_h__ 
#define __CATCreateSplitBySkin_h__ 

#include "ExportedByCATTopologicalObjects.h"

class CATTopSplitBySkin;
class CATGeoFactory;
class CATTopData;
class CATBody;
class CATSurface;
...
ExportedByCATTopologicalObjects CATTopSplitBySkin *
CATCreateSplitBySkin(CATGeoFactory * iFactory,
                     CATTopData    * iTopData,
                     CATBody       * iSolidBody,
                     CATBody       * iSkinBody);
