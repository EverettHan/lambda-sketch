#ifndef CATIPGMTopologicalBlendCurve_h_
#define CATIPGMTopologicalBlendCurve_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopologicalBlendCurve;

/**
 * Class defining the topological operator that connects two wire bodies.
 * <br> Continuity criteria can be precised: G0, G1 or G2.
 * <br>The CATIPGMTopologicalBlendCurve operator follows the global frame of the topological operators 
 ...
 *<ul>
 * <li>A CATIPGMTopologicalBlendCurve operator is created with the <tt>CATPGMCreateTopologicalBlendCurve</tt> global function.
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopologicalBlendCurve: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopologicalBlendCurve();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopologicalBlendCurve(); // -> delete can't be called
};
 ...
 * @see CATIPGMTopologicalBlendCurve
 */
...
#endif /* CATIPGMTopologicalBlendCurve_h_ */
