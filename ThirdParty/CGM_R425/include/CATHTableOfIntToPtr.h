...
//===================================================================
//
// CATHTableOfIntToPtr.h
//
//===================================================================
// June 2004 Creation: NDO
//===================================================================
#ifndef CATHTableOfIntToPtr_h
#define CATHTableOfIntToPtr_h
...
*/
class ExportedByPolyMathContainers CATHTableOfIntToPtr
{

public:

  CATHTableOfIntToPtr (const int iDimension = 0) : _HashTable (iDimension, 0, HashKey) {}

  CATHTableOfIntToPtr( const CATHTableOfIntToPtr& iOther ) : _HashTable( iOther._HashTable ) {}
...
public:
   ...
   * </ul>
   */
  HRESULT Insert (const int key, void* data) {return _HashTable.Insert (CATINT32ToPtr (key), data);}
   ...
   * </ul>
   */
  HRESULT InsertOrUpdate (const int key, void* data) {return _HashTable.InsertOrUpdate (CATINT32ToPtr (key), data);}
   ...
   */
  HRESULT Remove (const int key, void*& data) {return _HashTable.Remove (CATINT32ToPtr (key), data);}
   ...
   * </ul>
   */
  HRESULT Update (const int key, void* data) {return _HashTable.Update (CATINT32ToPtr (key), data);}

  /** 
   * Returns TRUE and the value associated to a key.  Returns FALSE if the key is not found in the map.
   */
  CATBoolean Locate (const int key, void*& data) const {return _HashTable.Locate (CATINT32ToPtr (key), data);}
...
public:
   ...
   */
  HRESULT Insert (const int key, void* data, Handle& oHandle) {return _HashTable.Insert (CATINT32ToPtr (key), data, oHandle);}
...
public:
  ...
  {
  public:
    Iterator (const CATHTableOfIntToPtr& map) : _It (map._HashTable) {}
    ~Iterator () {}
