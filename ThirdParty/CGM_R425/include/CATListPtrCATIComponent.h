#ifndef CATListPtrCATIComponent_H
#define CATListPtrCATIComponent_H
/* -*-c++-*- */
...
CATLISTP_DECLARE(CATIComponent)

typedef class CATLISTP (CATIComponent) CATListPtrCATIComponent;
