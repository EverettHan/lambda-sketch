/* -*-c++-*- */
#ifndef CATBasicBodyCircularPointsRadius_H
#define CATBasicBodyCircularPointsRadius_H

// COPYRIGHT DASSAULT SYSTEMES 1998
//=============================================================================
//
// CATBasicBodyCircularPointsRadius:
// Base class for implementations of the CircularPointsRadius basic CATBody
//
//=============================================================================
// Usage notes:
//
...
class ExportedByYJ000GSM CATBasicBodyCircularPointsRadius : public CATBasicBodyCircular
{
  public:

  CATBasicBodyCircularPointsRadius( const CATGeoFactory                             *iFactory,
  ...
  CATBasicBodyCircularPointsRadius ( const CATGeoFactory                          *Factory,
