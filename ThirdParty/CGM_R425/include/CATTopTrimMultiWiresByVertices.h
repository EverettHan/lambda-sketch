#ifndef __CATTopTrimMultiWiresByVertices_h__
#define __CATTopTrimMultiWiresByVertices_h__

// COPYRIGHT DASSAULT SYSTEMES 2010
//================================================================================
// Creation RLA  10/09/2016
//
...
class ExportedByBONEWOPE CATTopTrimMultiWiresByVertices: public CATTopMultiTrimPieces
{
  CATCGMVirtualDeclareClass(CATTopTrimMultiWiresByVertices);
public:
   /**
   * @nodoc
   * Constructor - not to be used.
   */
      CATTopTrimMultiWiresByVertices(CATGeoFactory * iFactory, CATTopData * iTopData,CATExtTopOperator * iExtensible);      
   ...
   public:
      ...
      * Destructor.
      */
      virtual ~CATTopTrimMultiWiresByVertices();
      ...
      */
       ...
       /**
      * @nodoc
      * The user choice the WiresBodies to keep
      */
...
/**
 * Creates a CATTopTrimMultiWiresByVertices operator.
 * @param iFactory
 ...
 * each vertex has only one WireBodySupport.
 * @param iWireBodies
...
ExportedByBONEWOPE  CATTopTrimMultiWiresByVertices*
CATCreateTrimMultiWiresByVertices(CATGeoFactory     * iFactory,
                            CATTopData        * iTopData,
                            CATLISTP(CATBody) & iSplittingBodies,
                            CATLISTP(CATBody) & iWireBodies);
