...
class ExportedByCATSysTS  CATUnicodeString  
{
   ...
   //------------------
     ...
     *   succeed, or <tt>1</tt> if the conversion did succeed.
     */
    int ConvertToNum(long *olongIntegerValue, const char *iCFormat="%d")  const;
     ...
     *   succeed, or <tt>1</tt> if the conversion did succeed.
     */
    int ConvertToNum(unsigned long *oUnslongIntegerValue, const char *iCFormat="%u") const;
