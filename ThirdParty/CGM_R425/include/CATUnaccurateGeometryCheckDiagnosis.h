...
#ifndef __CATUnaccurateGeometryCheckDiagnosis_h__
#define __CATUnaccurateGeometryCheckDiagnosis_h__
...
class ExportedByCheckOperators CATUnaccurateGeometryCheckDiagnosis: public CATCheckDiagnosisImpl
{
   public: // Methodes a usage externe
      ...
      CATUnaccurateGeometryCheckDiagnosis(    CATGeometry   * iGeometry      = (CATGeometry*)0,
      ...
      virtual ~CATUnaccurateGeometryCheckDiagnosis();
