...
//===================================================================
#ifndef CATPolyAtomicOperations_H
#define CATPolyAtomicOperations_H
...
class ExportedByPolyMultiThreading CATPolyAtomicOperations
{
public:
  /**
...
INLINE int CATPolyAtomicOperations::Increment(int * ioValue)
{
  return DSYSysInterlockedIncrement(ioValue);
}

INLINE int CATPolyAtomicOperations::Decrement(int * ioValue)
{
  return DSYSysInterlockedDecrement(ioValue);
}

INLINE int CATPolyAtomicOperations::CompareAndSwap(int * destination, int swap, int comparand)
{
  return DSYSysInterlockedCompareExchangeInt32(destination, swap, comparand);
}

INLINE int CATPolyAtomicOperations::BitWiseOr(int * destination, int value)
{
  int init = 0;
  int result = 0;
  do
...
INLINE int CATPolyAtomicOperations::BitWiseTestAndReset(int * destination, int value)
{
  int init = 0;
  int result = 0;
  do
