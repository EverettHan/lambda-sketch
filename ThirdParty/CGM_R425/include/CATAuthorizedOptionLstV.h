...
//    Creation  Feb 98                                           ADH
//-------------------------------------------------------------------------
// CATAuthorizedOptionLstP :
//    Classe liste de pointeurs sur CATAuthorizedOption
//--------------------------------------------------------------------------

#ifndef CATAuthorizedOptionLstV_H
#define CATAuthorizedOptionLstV_H
/*
...
// @c++ansi aew 2004-08-02.20:04:50 [Replace forward declaration of standard streams with iosfwd.h] 
 #include "iosfwd.h" 
#else //!_CAT_ANSI_STREAMS 
class ostream;
#endif //_CAT_ANSI_STREAMS

class CATAuthorizedOption ;
...
//
// declaration du type CATLISTVtrCATAuthorizedOption
//
CATLISTV_DECLARE (CATAuthorizedOption)

//
// type homonyme
//
typedef  CATLISTV(CATAuthorizedOption)  CATAuthorizedOptionLstV;
*/
#endif
