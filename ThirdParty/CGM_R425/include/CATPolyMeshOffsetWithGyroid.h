...
//===================================================================
//
// CATPolyMeshOffsetWithGyroid.h
// Header definition of CATPolyMeshOffsetWithGyroid
//
...
//===================================================================
//
// July 2021  Creation: RPO3
//===================================================================
#ifndef CATPolyMeshOffsetWithGyroid_H
#define CATPolyMeshOffsetWithGyroid_H

#ifndef _MOBILE_SOURCE

//#include "CATFuzzyPolyOper.h" // Exported By
#include "CATFuzzyOperatorsAdv.h"
...
class ExportedByCATFuzzyOperatorsAdv CATPolyMeshOffsetWithGyroid
{
...
public:
  ...
  **/
  virtual ~CATPolyMeshOffsetWithGyroid() {};
...
*/
ExportedByCATFuzzyOperatorsAdv CATPolyMeshOffsetWithGyroid* CATCreateCATPolyMeshOffsetWithGyroid(CATSoftwareConfiguration * iSoftwareConfiguration,
                                                                                                  const CATTolerance & iTol,
                                                                                                  const LatticeNBModel &iInputGyroid,
                                                                                                  CATIPolyMesh &oResultMesh,
                                                                                                  double iOffsetValue,
                                                                                                  double iClientMaxDeviation,
																								                                                  const std::string& iStrGyroid,
