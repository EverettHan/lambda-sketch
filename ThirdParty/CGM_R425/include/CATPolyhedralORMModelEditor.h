/* -*-C++-*-*/
#ifndef CATPolyhedralORMEditor_H
#define CATPolyhedralORMEditor_H

//=============================================================================
//
// COPYRIGHT : DASSAULT SYSTEMES 2022
//
// CATPolyhedralORMModelEditor
//
// DESCRIPTION :
//  Operator allowing the user to navigate through an OrmModel and edit it.
//
// History
// May 2022 : RBU3 : Creation
//=============================================================================
...
* </ul>
*/
class ExportedByGMPolyORMOper CATPolyhedralORMModelEditor : public CATGMPolyGeoOperator
{
  CATCGMVirtualDeclareClass(CATPolyhedralORMModelEditor);
...
public:
  ...
  * Destructor
  */
  virtual ~CATPolyhedralORMModelEditor();
  ...
  // Return E_FAIL if the id is not in the OrmModel.
  //--------------------------------------------------------------------------
  virtual HRESULT GetNodePosition(int iIdNodeInOrmModel, CATMathPoint &oPosition) = 0;
  ...
  //--------------------------------------------------------------------------
  virtual HRESULT ComputeNodesDensity(CATBoolean iIgnoreFrozenElements = TRUE,
    CATBoolean iWeightedMean = TRUE, CATBoolean iKeepElementDensityInModel = FALSE) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel.
  //--------------------------------------------------------------------------
  virtual HRESULT GetNeighborsOfNode(int iIdNodeInOrmModel, CATListOfInt &oNeighboors) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel.
  //--------------------------------------------------------------------------
  virtual HRESULT GetElementsAroundNode(int iIdNodeInOrmModel, CATListOfInt &oElementsAround) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT GetElementNodes(int iIdElemInOrmModel, CATListOfInt &oNodesIdx) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT SetElementDensity(int iIdElemInOrmModel, float iDensity) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT GetElementDensity(int iIdElemInOrmModel, float &oDensity) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT GetElementNeighbors(int iIdElemInOrmModel, CATListOfInt &oNeighbordsIdx) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT IsElementFrozen(int iIdElemInOrmModel, CATBoolean &oFrozen) = 0;
  ...
  // Return E_FAIL if the id is not in the OrmModel
  //--------------------------------------------------------------------------
  virtual HRESULT SetElementFrozen(int iIdElemInOrmModel, CATBoolean iFrozen) = 0;
  ...
  //--------------------------------------------------------------------------
  virtual HRESULT GetNewElementsAfterConversion(int iIdElem, CATListOfInt &oIdxNewElements) = 0;
  ...
  //--------------------------------------------------------------------------
  virtual HRESULT ComputeVolumeAtIsoValue(double iIsoValue, double &oVolume, CATLISTP(CATCell) *iListOptimizableVolumes = NULL) = 0;
  virtual HRESULT ComputeVolumeAtIsoValue(double iIsoValue, double &oVolume, CATListOfInt iListTagOfOptimizableVol) = 0;
  ...
  //
  // Description: 
  //  Get all the elements that contain the isoValue.
  ...
  //   It will still contains all the nodes.
  //
...
protected:
  ...
  */
  CATPolyhedralORMModelEditor(CATGeoFactory & iFactory, CATGMPolyOperGeoExt &iExtensible);
...
private:
  ...
  CATPolyhedralORMModelEditor();
  CATPolyhedralORMModelEditor(const CATPolyhedralORMModelEditor& iOneOf);
  CATPolyhedralORMModelEditor& operator =(const CATPolyhedralORMModelEditor& iOneOf);
};


/**
 * Creates a CATPolyhedralORMModelEditor operator
 ...
 */
ExportedByGMPolyORMOper CATPolyhedralORMModelEditor * CATCreatePolyhedralORMModelEditor(CATGeoFactory * iFactory, CATSoftwareConfiguration * iConfig,
  CATCGMOrmModel * iOrmModel, CATBoolean iDuplicateMode=FALSE);

#endif /*CATPolyhedralORMEditor_H*/
