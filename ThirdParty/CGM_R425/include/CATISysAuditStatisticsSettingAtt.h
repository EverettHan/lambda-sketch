...
//===========================================================================
# ifndef _CATISYSAUDITSTATISTISSETTINGSATT
# define _CATISYSAUDITSTATISTISSETTINGSATT
...
extern ExportedByJS03TRA IID IID_CATISysAuditStatisticsSettingAtt;
#else
extern "C" const IID IID_CATISysAuditStatisticsSettingAtt;
#endif


/**
* Interface to handle the parameters of the audit statistic.
* <b>Role</b>: This interface is implemented by a component which
* represents the controller of the audit statistic. 
...
*/
class ExportedByJS03TRA CATISysAuditStatisticsSettingAtt : public CATISysGeneralStatisticsSettingAtt
{
  CATDeclareInterface;
...
# endif /* _CATISYSAUDITSTATISTISSETTINGSATT */
