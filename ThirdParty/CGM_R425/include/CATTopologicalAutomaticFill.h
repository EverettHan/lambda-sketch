#ifndef CATTopologicalAutomaticFill_H
#define CATTopologicalAutomaticFill_H
...
* 
* <br>The CATTopologicalAutomaticFill operator creates the resulting filling skin body
* separately from the inputs: the wires of the input bodies are not used to define the topology
* of the resulting fill body.  
*<ul>
* <li>A CATTopologicalAutomaticFill operator is created with the <tt>CreateTopologicalAutomaticFill</tt> global function.
...
*/
//-----------------------------------------------------------------------------
class ExportedByCATSurfacicTopoOperators
CATTopologicalAutomaticFill:public CATTopologicalFill {
  CATCGMVirtualDeclareClass(CATTopologicalAutomaticFill);
 public:
...
/** @nodoc */
CATTopologicalAutomaticFill(CATGeoFactory* iFactory, CATTopData* iTopData);
  
 /** @nodoc */
CATTopologicalAutomaticFill(CATGeoFactory* factory, CATCGMJournalList* journal=0);

//=============
//  Destructor 
//=============

virtual ~CATTopologicalAutomaticFill();
...
/** 
  ...
  */
  virtual void SetPassingCurves(ListPOfCATBody const & iListOfWires)=0;
  ...
  */
   ...
   */
  virtual void SetPassingPoints(ListPOfCATBody const & iListOfVertices)=0;
 ...
 /** 
  ...
  /** @nodoc @nocgmitf
  * Only for limited use.For IDX only.
  * Defines if a given wire is a FreeBoundary or not
  * @param iWhichWire
  * The index (beginning at 1) of the input wire.
  * @param isFree
  * The FreeBoundary  mode
  * <br><b>Legal values</b>: <tt>FALSE</tt>  the wire is not a free boundary.
  * or <tt>TRUE</tt>  the wire is a Free Boundary.
  */
  virtual  void SetIsFreeBoundary(const CATLONG32 iWhichWire, const CATBoolean isFree) = 0;
 ...
 */
 ...
 /** 
   ...
   * 
  */
  virtual int SetCuttingWires(ListPOfCATBody const & iListOfWires)=0;
 ...
 /**  @nodoc @nocgmitf */ 
	...
	/** @nodoc @nocgmitf
	 *  Only for limited use. For IDX only.
	 *  RoundnessFactor: design coefficient
	 *  The smaller the value, the more rounded the shape will be.
	 *  IValue must be greater than 0 otherwise HRESULT=E_FAIL
	 */
	virtual HRESULT SetRoundnessFactor(const double iValue) = 0;

	/** @nodoc @nocgmitf
	*  Only for limited use.For IDX only.
	*  Same inner multiplicity on  the result
	*/
 ...
 * a complex topology.
 */
  virtual  CATTopologicalFill::CATFillType GetFillType () =0;
...
* where the maximum has been reached.
*/
  virtual double GetG2MaxDeviation(const CATEdge * iEdge, CATMathPoint * ioMaxPoint=NULL)=0;
...
*/
  ...
  */
  virtual void GetSurfaceParameters ( int &  oDegreeU, int  & oDegreeV, int  & oNumberUOfPatch, int &  oNumberVOfPatch)=0;
  ...
  */ 
  ...
  virtual void SetJournalTypeForFaceFill()=0;
   ...
   //only for Live Shape use 
   /**  @nodoc @nocgmitf */ 
   virtual void SetJournalFix()=0;
...
ExportedByAutoFill
CATTopologicalAutomaticFill * CATCreateTopologicalAutomaticFill(CATGeoFactory          * iFactory,
                                                                CATTopData             * iData,
