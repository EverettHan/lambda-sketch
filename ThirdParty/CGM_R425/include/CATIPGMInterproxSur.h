#ifndef CATIPGMInterproxSur_h_
#define CATIPGMInterproxSur_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMInterproxSur;
 ...
 * <ul><li>Create it with the <tt>CATPGMCreateInterproxSur</tt> global method. The run is automatically done and the
 * input surfaces are directly deformed.
 * <li>Release the operator with the <tt>Release</tt> method after use.
 * </ul>
 * <br>To use it in <tt>ADVANCED</tt> mode:
 * <ul><li>Create it with the <tt>CATPGMCreateInterproxSur</tt> global method.
 ...
 * </ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMInterproxSur: public CATIPGMVirtual
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMInterproxSur(); // -> delete can't be called
};

#endif /* CATIPGMInterproxSur_h_ */
