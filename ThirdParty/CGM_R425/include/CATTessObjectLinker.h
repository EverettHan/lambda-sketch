/* -*-C++-*-*/
#ifndef CATTessObjectLinker_H
#define CATTessObjectLinker_H
...
//-----------------------------------------------------------------------------
class CATTessBlockLinkObject;
class CATTessLinkObject;

class ExportedByTessImpl CATTessObjectLinker
{
public:
//=============================================================================
 ...
 */
  CATTessObjectLinker(CATLONG32 iEstimatedSize = 97, int iObjectIsPointer = 1);
 ...
 */
  void AddLink(CATTessLinkObject * iAddLink);

/** Retrieves a link from a pointer.
 */
  CATTessLinkObject * RetrieveLink(void * iPointerOnObject);
...
protected:
  ...
  CATTessBlockLinkObject * _FirstBlockLink;

  // Current block of links
  CATTessBlockLinkObject * _CurrentBlockLink;

  // Current link in the block
  CATTessLinkObject      * _CurrentLink;

  // Array of buckets
  CATTessLinkObject     ** _Buckets;
...
//=============================================================================
inline unsigned int CATTessObjectLinker::ComputeKey(void * Pointer)
{
