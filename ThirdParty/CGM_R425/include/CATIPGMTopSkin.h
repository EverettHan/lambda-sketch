#ifndef CATIPGMTopSkin_h_
#define CATIPGMTopSkin_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopSkin;
 ...
 * <br>To use the CATIPGMTopSkin:
 * <ul><li>Create it the <tt>CATPGMCreateTopSkin</tt> global function. 
 ...
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopSkin: public CATIPGMGeoToTopOperator
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopSkin(); // -> delete can't be called
};
...
/** @nodoc */
ExportedByCATGMOperatorsInterfaces CATBody *CATPGMCreateSkin(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATSurface *iSurface,
  const CATSurLimits *iLims);
