#ifndef CATIOmbImporter_H
#define CATIOmbImporter_H
...
extern ExportedByCATOmbImportExport IID IID_CATIOmbImporter ;
...
class ExportedByCATOmbImportExport CATIOmbImporter: public CATBaseUnknown
{
  CATDeclareInterface;
  ...
  public:
    ...
    */
	virtual HRESULT ImportILBOfExtensionAndUsageIntoSession ( CATILockBytes2& iStream, 
                                                            const CATUnicodeString& iExtension,
                                                            const CATUnicodeString& iUsage, 
                                                            CATOmbImportExportParameters* iParameters , 
                                                            CATBaseUnknown *& oRootComponent) = 0;
  ...
  /** 
	 ...
	 * the same extension is used for different data) or E_FAIL otherwise
    */
	virtual HRESULT ImportFileOfExtensionAndUsageIntoSession (const CATUnicodeString& iFilePath,
                                                            const CATUnicodeString& iExtension,
                                                            const CATUnicodeString& iUsage, 
                                                            CATOmbImportExportParameters* iParameters, 
                                                            CATBaseUnknown*& oRootComponent) = 0;
  ...
  */
virtual HRESULT CanImportFileIntoSession (const CATUnicodeString& iFilePath, 
                                          CATUnicodeString& ioExtension, CATUnicodeString& ioUsage)=0;
  ...
  * S_OK if it know how to import the file
  */
virtual HRESULT CanImportILBIntoSession (CATILockBytes2& iStream, CATUnicodeString& ioExtension, 
                                 CATUnicodeString& ioUsage)=0;

};


CATDeclareHandler( CATIOmbImporter, CATBaseUnknown );
