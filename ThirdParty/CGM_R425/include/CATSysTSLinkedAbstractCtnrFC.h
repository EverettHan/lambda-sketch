// CATSysTSLinkedAbstractCtnrFC.h
// 
...
#ifndef _CATSysTSLinkedAbstractCtnrFC_h_
#define _CATSysTSLinkedAbstractCtnrFC_h_
...
class ExportedByCATSysTS CATSysTSLinkedAbstractCtnrFC
{
public:
