#ifndef CATIPGMFrFSmoothingOper_h_
#define CATIPGMFrFSmoothingOper_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMFrFSmoothingOper;

/**
 * Class defining a geometric operator that smoothes a set of iNbrePts points to create a set of curves "SetOfCurves".
 * <br>The CATIPGMFrFSmoothingOper operator follows the global frame of the geometric operators:
 * <ul>
 * <li>A CATIPGMFrFSmoothingOper operator is created with the <tt>CATFrFCreateSmoothingOper</tt> global method
 ...
 * </ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMFrFSmoothingOper: public CATIPGMOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMFrFSmoothingOper();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMFrFSmoothingOper(); // -> delete can't be called
};
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMFrFSmoothingOper *CATPGMFrFCreateSmoothingOper(
...
#endif /* CATIPGMFrFSmoothingOper_h_ */
