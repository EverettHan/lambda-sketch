...
//=============================================================================
//
// <ClassName>: CATTopShellFlattener
//
//=============================================================================
// Usage Notes:
//
//
//=============================================================================
//  11:10:10  Creation               S9L
//  11:10:10  Modification           S9L
//=============================================================================

#ifndef CATTopShellFlattener_H
#define CATTopShellFlattener_H

#include "ShellFlattener.h"      // exported by
...
class ExportedByShellFlattener CATTopShellFlattener : public CATTopOperator
{
   CATCGMVirtualDeclareClass(CATTopShellFlattener);
public:   
   /** @nodoc 
     * cannot be called
   ...
   // Constructor
   //
   CATTopShellFlattener(CATGeoFactory * ipFactory, CATTopData * ipTopData);
   
   //
   // Destructor
   //
   virtual ~CATTopShellFlattener();
   ...
   virtual CATBoolean SetEdgesToTear(
                             const ListPOfCATEdge   &   iEdgesToTear,
                             CATLONG32            &   oNbAmbiguities,
                             ListPOfCATEdge      &   oCandidateEdgesToTear,
                             ListPOfCATEdge      &   oInvalidInputEdges,
                             ListPOfCATEdge      *   ioMandatoryCandidates = NULL,
                             ListPOfCATEdge      *   ioOptionalCandidates = NULL) = 0;
   ...
   //
   virtual int SetInitialLocation(CATVertex * ipVertxOrign, CATEdge * ipEdgeX, CATFace * ipFace = NULL) = 0;
   ...
   //
   virtual int SetInitialLocation(const CATMathPlane & ipIniPlane, CATFace * ipSuppFace = NULL) = 0;
   ...
   // 
   virtual void SetToolData(const ListPOfCATFace * iplistOfCATFace, double * pTool) = 0;
   ...
   virtual void SetWireImages(
                        const ListPOfCATBody      &  iWiresToConstraint, 
                        const ListPOfCATBody      &  iWiresImages,
   ...
   virtual void SetZeroRadiusBendEdges(
                              const ListPOfCATEdge   & iListOfBendEdges, 
   ...
   virtual void SetBendFaces(
                       const ListPOfCATFace    & iListOfBendFaces, 
   ...
   //
   virtual void RunTransfer(CATBody * ipBody, CATBody *& opBody,  CATCGMJournalList * ipReport, CATBoolean iReverse = FALSE) = 0;
   ...
   virtual int RunTransfer(
                      const ListPOfCATBody       & iBodiesToTransfer,
                            ListPOfCATBody       & ioBodiesTransferred,
                            CATCGMJournalList    * ipReport,         //Not filled if NULL
   ...
   // 
   virtual ListPOfCATEdge GetEdgesMustToTear() = 0;

   //
   // Get 2D transformation
   // return resulting face if transformation is found
   //
   virtual CATFace * GetTransformation2D(CATFace * ipFace, CATMathTransformation2D & oTransformation2D) = 0;
   ...
   //
   virtual int GetCellImage(CATCell * ipCell, CATLISTP(CATCell) &oCellsInOtherImage, CATBoolean iReverse = FALSE) = 0;
};

ExportedByShellFlattener   CATTopShellFlattener * CATCreateTopShellFlattener( 
