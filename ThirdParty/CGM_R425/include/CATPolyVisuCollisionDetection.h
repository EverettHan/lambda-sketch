...
//===================================================================
//
// CATPolyVisuCollisionDetection.h
//
//===================================================================
//
// Usage notes:
// Interface for the PolyBody Set operator
// CATPolyBodySetCollisionDetection, detecting collisions between
...
#ifndef CATPolyVisuCollisionDetection_h
#define CATPolyVisuCollisionDetection_h
 ...
 */
class ExportedByPolyVisuClash CATPolyVisuCollisionDetection
{
public:
   ...
   */
  CATPolyVisuCollisionDetection(const CATTolerance & iTol = CATGetDefaultTolerance());
  ~CATPolyVisuCollisionDetection();
...
private:
  ...
  CATPolyBodySetCollisionDetection _BVHSetOper;
};

#endif /* CATPolyVisuCollisionDetection_h */
