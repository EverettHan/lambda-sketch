#ifndef CATIPGMTopEdgePropagation_h_
#define CATIPGMTopEdgePropagation_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMTopEdgePropagation;

/**
 * Class representing the topological operator which performs an edge propagation on a body.
 * <ul>
 * <li>Create it with the CATPGMCreateTopEdgePropagation global function.
 ...
 * </ul>
*/
class ExportedByCATGMModelInterfaces CATIPGMTopEdgePropagation: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopEdgePropagation();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopEdgePropagation(); // -> delete can't be called
};

/**
  * Creates a CATIPGMTopEdgePropagation operator.
  * @param iFactory
  ...
  */
ExportedByCATGMModelInterfaces CATIPGMTopEdgePropagation *CATPGMCreateTopEdgePropagation(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATBody *iBody,
  CATEdge *iInitialEdge);

#endif /* CATIPGMTopEdgePropagation_h_ */
