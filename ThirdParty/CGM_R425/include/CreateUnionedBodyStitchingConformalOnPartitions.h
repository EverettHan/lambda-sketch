#ifndef CreateUnionedBodyStitchingConformalOnPartitions_H
#define CreateUnionedBodyStitchingConformalOnPartitions_H
...
namespace lattice
{
  namespace gm
  {
    ...
    {
      /**
      * @brief Wrapper of lattice::gm::CreateUnionedBodyStitchingConformal to process
      * a partitioned body and process the arguments of lattice::gm::CreateUnionedBodyStitchingConformal
      ...
      */
      HRESULT CreateUnionedBodyStitchingConformalOnPartitions(
