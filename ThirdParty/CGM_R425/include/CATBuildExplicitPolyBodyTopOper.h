/* -*-C++-*-*/
#ifndef CATBuildExplicitPolyBodyTopOper_H
#define CATBuildExplicitPolyBodyTopOper_H

//=============================================================================
//
// COPYRIGHT : DASSAULT SYSTEMES 2021
//
// CATBuildExplicitPolyBodyTopOper
//
// DESCRIPTION:
...
* <ul>
*     <li> A <tt>CATBuildExplicitPolyBodyTopOper</tt> operator is created with the <tt>CATCreateBuildExplicitPolyBodyTopOper</tt> global function.
...
* </ul>
*/
class ExportedByGMScalarFieldsOperators CATBuildExplicitPolyBodyTopOper : public CATImplicitTopOperator
{
  CATCGMVirtualDeclareClass(CATBuildExplicitPolyBodyTopOper);
...
public:
  ...
  * Destructor
  */
  virtual ~CATBuildExplicitPolyBodyTopOper();
...
protected:
  ...
  */
  CATBuildExplicitPolyBodyTopOper(CATGeoFactory & iFactory, const CATTopData & iTopData, CATImplicitOperTopExt &iExtensible);
...
private:
  ...
  CATBuildExplicitPolyBodyTopOper();
  CATBuildExplicitPolyBodyTopOper(const CATBuildExplicitPolyBodyTopOper& iOneOf);
  CATBuildExplicitPolyBodyTopOper& operator =(const CATBuildExplicitPolyBodyTopOper& iOneOf);
};

/**
 * Creates a CATBuildExplicitPolyBodyTopOper operator
 * @param iFactory
 ...
 */
ExportedByGMScalarFieldsOperators CATBuildExplicitPolyBodyTopOper * CATCreateBuildExplicitPolyBodyTopOper(CATGeoFactory * iFactory, CATTopData * iTopData, CATBody * iBodyWithCavityToLattice);

#endif /* CATBuildExplicitPolyBodyTopOper_H */
