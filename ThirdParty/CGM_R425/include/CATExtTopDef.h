...
//=============================================================================
// Oct. 2022   Creation                                                     DPS
//-----------------------------------------------------------------------------
//
// Virtual extensible class for CATTopDeformation operator (and derivations)
// in order to take advantage of the delegation mechanism for polyhedral bodies
//
//=============================================================================
#ifndef CATExtTopDef_h
#define CATExtTopDef_h

#include "CATExtTopOperator.h"      // Derivation
#include "InfraMorph.h" // ExportedBy
...
class CATTopDeformation; // Master CATTopOperator defined in CATTopDeformation.h
class CATBody;
class CATShell;
class CATVertex;
...
class ExportedByInfraMorph CATExtTopDef : public CATExtTopOperator
{
public:
  ...
  virtual ~CATExtTopDef();


  //=============================================================================
  // static method under study, do not use yet
  // Retrieve the specific operator extension as a CATExtTopDef pointer, from the CATTopologicalFill master operator
  ...
  //=============================================================================
  static CATExtTopDef * GetTopDefExtensible(const CATTopDeformation& iControlledExclusiveOwnerTopOper);
