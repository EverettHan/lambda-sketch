#ifndef CATIPGMCreateReflectCurve_h_
#define CATIPGMCreateReflectCurve_h_
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMReflectCurve *CATPGMCreateReflectCurve(
...
#endif /* CATIPGMCreateReflectCurve_h_ */
