/* -*-C++-*-*/
#ifndef LatticeVersioningHelp_H
#define LatticeVersioningHelp_H

//=============================================================================
//
// COPYRIGHT : DASSAULT SYSTEMES 2021
//
// LatticeVersioningHelp 
//
// DESCRIPTION :
...
#include "ExportedByLatticeGMOperators.h" // ExportedBy
...
class ExportedByLatticeGMOperators LatticeVersioningHelp
{
public:
...
public:
  ...
  * Constructor
  */
  LatticeVersioningHelp (CATSoftwareConfiguration * iConfig=NULL);
  ...
  */
   ...
   */
  CATSoftwareConfiguration * UpdateLevel(LatticeVersioningHelp::DefaultLevel iRequestedLevel = _V5R29SP4_V6R421_FD04_);
...
private:
  ...
  LatticeVersioningHelp & operator =(const LatticeVersioningHelp & iOneOf);
  LatticeVersioningHelp(const LatticeVersioningHelp & iOneOf); 
...
INLINE CATBoolean LatticeVersioningHelp::CheckActivationLevel(int iVersioningVarValue) {
  CATBoolean ret = (_ConfigLevel >= iVersioningVarValue);
  return ret; }

INLINE CATSoftwareConfiguration * LatticeVersioningHelp::GetSoftwareConfiguration() {
  return _Config;
}
