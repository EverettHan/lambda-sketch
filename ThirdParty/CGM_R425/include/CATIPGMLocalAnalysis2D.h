#ifndef CATIPGMLocalAnalysis2D_h_
#define CATIPGMLocalAnalysis2D_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMLocalAnalysis2D;
 ...
 * The point where the analysis is done can be changed by @href CATIPGMLocalAnalysis2D#SetParam.
 */
class ExportedByCATGMModelInterfaces CATIPGMLocalAnalysis2D: public CATIPGMVirtual
{
public:
  /**
   * Constructor
   */
  CATIPGMLocalAnalysis2D();

  /**
  * Retrieves the first fondamental form at the point of <tt>this</tt> CATIPGMLocalAnalysis2D.
	* @param ioE
  ...
  */
  ...
  /**
  * Retrieves the second fondamental form at the point of <tt>this</tt> CATIPGMLocalAnalysis2D.
  ...
  */
  ...
  /**
  * Returns the gaussian curvature at the point of <tt>this</tt> CATIPGMLocalAnalysis2D.
	* @return
  ...
  */
  ...
  /**
  * Returns the mean curvature at the point of <tt>this</tt> CATIPGMLocalAnalysis2D.
	* @return
  ...
  */
  ...
  /**
  * Returns the min and max curvatures at the point of <tt>this</tt> CATIPGMLocalAnalysis2D.
	* @param ioCmin
  ...
  */
  virtual void MovePoint(const CATSurParam &iPar, CATSurParam &ioPar) = 0;

  /**
 * Tests whether the point of <tt>this</tt> CATIPGMLocalAnalysis2D is regular.
 ...
 */
  ...
  /**
 * Modifies the point where <tt>this</tt> CATIPGMLocalAnalysis2D is performed.
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMLocalAnalysis2D(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMLocalAnalysis2D *CATPGMCreateLocalAnalysis2D(
...
*/
ExportedByCATGMModelInterfaces CATIPGMLocalAnalysis2D *CATPGMCreateLocalAnalysis2D(
  const CATIPGMLocalAnalysis2D &iAnalysisToCopy);

#endif /* CATIPGMLocalAnalysis2D_h_ */
