#ifndef CATICDSSymmetricIJJoint_H
#define CATICDSSymmetricIJJoint_H
 ...
 */
class ExportedByCDSInterface CATICDSSymmetricIJJoint : public CATICDSJoint
{
public:
  ...
  /**
   * Creates an instance of the CATICDSSymmetricIJJoint joint.
   * @param ipFactory
   ...
   */
  static CATICDSSymmetricIJJoint* Create(CATICDSFactory *ipFactory,
                                      CATICDSAxis* ipAxis1,
                                      CATICDSAxis* ipAxis2,
                                      CATICDSPlane* ipPlane);

  virtual ~CATICDSSymmetricIJJoint() {}
};
