...
public :
  ...
  */
  virtual void      AddDomain( CATDomain * iDomain   ,
  ...
  * <tt>iBoundingCell</tt>.
  */
  virtual void AddBoundingCell   ( CATCell    * iBoundingCell   ,
    ...
    */
  virtual void RemoveBoundingCell( CATCell   * iCellToRemove,
  ...
  *   </dl>
  */
  virtual HRESULT  GetNeighborCells(CATCell*           iBorderCell,
                                    CATBody*           iInBody,
                                    CATLISTP(CATCell)& ioNeighborCells,
                                    CATListOfLong    * ioRelativeOrientations =NULL ) = 0;
  ...
  */
  virtual void         GetLyingOn         (CATLISTP(CATCell)& ioSupports,
                                           CATBody          * iInBody   ) = 0;
  ...
  *   </dl>
  */
  virtual HRESULT CellNeighbours( CATBody         * inBody,
                                  ListPOfCATCell  & oNeighbourCells) =0;
  ...
  */
  virtual void GetLyingGeometriesOn(CATCell              * iSupport        ,
                                    CATLISTP(CATGeometry)& ioGeomSupports) = 0;
  ...
  */
  virtual void  GetFederatorsLyingOn(CATBody               * iInBody              ,
                                     CATLISTP(CATTopology) & ioFederatorsSupport) = 0;

  
  /**
  * @nodoc
  */
  virtual void         SetLyingOn         (CATCell    * iSupport                ,
                                           CATGeometry* iWithAssociatedGeometry = NULL) = 0;
  /**
  * @nodoc
  */  
