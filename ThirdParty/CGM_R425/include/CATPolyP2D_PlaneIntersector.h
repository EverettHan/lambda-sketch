...
//============================================================================================
#ifndef CATPolyP2D_PlaneIntersector_H
#define CATPolyP2D_PlaneIntersector_H
...
class ExportedByCATPolyCanonicOperators CATPolyP2D_PlaneIntersector
{
...
public:
  ...
  // -------------------------------------
  CATPolyP2D_PlaneIntersector (CATIPolyMesh * iPolyMesh);
  virtual ~CATPolyP2D_PlaneIntersector ();
  ...
  HRESULT Run (CATMathPlane &iPlane, int iIdxVertexDeb = 0);
  ...
  HRESULT RunOnVertex (int iIdxVertex, CATMathPoint &oCentreCercle, double &oRayonCercle,              
    CATMathVector &oDirection, double &oErrQuadra, CATListOfDouble &LstPntCut, double &oAngleOuverture);

  // A partir de la liste de point d'intersection _LstOfResult sur un cercle de centre, direction 
  // et rayon donnees, la fonction calcule l'angle d'ouverture de l'arc constitue par les points 
  // Elle retourne egalement la liste des points d'intersection ordonnee
  HRESULT ComputeAngle(const CATMathPoint & Centre, const CATMathVector & Direction, double Rayon, 
                    double &oAngle, CATListOfDouble &oLstPntCut);
  ...
  double             * _Poids;          // Le scalaire associe à chaque sommet fonction du plan
