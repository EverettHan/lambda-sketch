#ifndef CATPGMCreateSketchGeodesic_h_
#define CATPGMCreateSketchGeodesic_h_
...
*/
//
ExportedByCATGMOperatorsInterfaces CATIPGMSketchGeodesic *CATPGMCreateGeodesicPointDir(
...
#endif /* CATPGMCreateSketchGeodesic_h_ */
