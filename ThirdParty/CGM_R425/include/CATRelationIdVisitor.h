#ifndef CATRelationIdVisitor_H
#define CATRelationIdVisitor_H
/* -*-c++-*- */
 ...
 */
class ExportedByCATPLMTos CATRelationIdVisitor
{
public:
  ...
  */
  ...
  CATRelationIdVisitor();
  virtual ~CATRelationIdVisitor();
  virtual CATBehaviour Visit(CATRelationId & iRID) = 0;
};
