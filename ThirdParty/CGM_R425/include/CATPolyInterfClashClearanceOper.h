...
#ifndef CATPolyInterfClashClearanceOper_h
#define CATPolyInterfClashClearanceOper_h
 ...
 */
class ExportedByCATPolyBoundingVolumeOperators CATPolyInterfClashClearanceOper : public CATPolyInterfClashOper
{
public:
   ...
   */
  CATPolyInterfClashClearanceOper(const CATTolerance & iTol = CATGetDefaultTolerance());

  CATPolyInterfClashClearanceOper( const CATPolyInterfClashClearanceOper& iOther );

  virtual ~CATPolyInterfClashClearanceOper();
  ...
  virtual CATPolyInterfClashClearanceOper* Clone() const;
  ...
  /** Debug */
  virtual CATPolyInterfClashClearanceOper *        CastToClashClearanceOper() {return this;}
  /** Debug */
...
#endif /* CATPolyInterfClashClearanceOper_h */
