#ifndef CATIPGMTopSimilarCurve_h_
#define CATIPGMTopSimilarCurve_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopSimilarCurve;

/**
 * Class defining the topological operator that connects two wires with 
 * the "Base Curve" option.
 *<ul>
 * <li>A CATIPGMTopSimilarCurve operator is created with the <tt>CATPGMCreateTopSimilarCurve</tt> global function;
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopSimilarCurve: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopSimilarCurve();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopSimilarCurve(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopSimilarCurve *CATPGMCreateTopSimilarCurve(
...
#endif /* CATIPGMTopSimilarCurve_h_ */
