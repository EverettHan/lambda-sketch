#ifndef CATPGMCreateTopBoolean_h_
#define CATPGMCreateTopBoolean_h_
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopSplitShell(
...
* </ul>
* @param iExtrapolMode
* The extrapolation mode when the cutting body does 
* not cut right along the body to cut:
* <ul>
* <li><tt>NO_EXTRAPOLATION</tt>: No extrapolation is performed. The operator cannot find a solution
* if the cutting body does not cut right along the body to cut.
* <li><tt>TANGENT_DIRECTION</tt>: If the cutting body does not cut right along the body to cut, the extrapolation is
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopNewSplitShell(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToCut,
  CATBody *iCuttingBody,
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimShell(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToTrim,
 ...
 * The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
 */
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimShellWithWirePositionning(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToTrim,
  CATBody *iTrimmingBody,
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopSplitWire(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToCut,
  CATBody *iCuttingBody,
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopNewSplitWire(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToCut,
  CATBody *iCuttingBody,
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimWire(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToTrim,
  CATBody *iTrimmingBody,
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybDisconnect *CATPGMCreateTopDisconnectWire(
  CATGeoFactory *iFactory,
  CATTopData *iData,
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybDisconnect *CATPGMCreateTopDisconnectShell(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToDisconnect,
  CATBody *iDisconnectingBody);
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopSplitShellWithKeepRemove(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToCut,
  CATBody *iCuttingBody);
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimShellWithKeepRemove(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToTrim,
  CATBody *iTrimmingBody);
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybSplit *CATPGMCreateTopSplitWireWithKeepRemove(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToCut,
  CATBody *iCuttingBody);
...
* The pointer to the created operator. To be released with the <tt>Release</tt> method afer use.
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimWireWithKeepRemove(
  CATGeoFactory *iFactory,
  CATTopData *iData,
  CATBody *iBodyToTrim,
  CATBody *iTrimmingBody);
...
#endif /* CATPGMCreateTopBoolean_h_ */
