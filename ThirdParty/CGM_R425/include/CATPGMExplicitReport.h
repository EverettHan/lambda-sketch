#ifndef CATPGMExplicitReport_h_
#define CATPGMExplicitReport_h_
...
*           The List of values that describe this anomaly are :
*
*     @param CATCGMEdgeDomain_InconsistentEdgeOrientation       :
*		------------------------------------------
*
*			- Definition :
*			--------------
...
*           The List of values that describe this anomaly are : 
*
*     @param CATCGMFace_Closed       :
*		------------------------------------------
*
*			- Definition : This check verifies whether a model contains closed faces, 
*                    i.e. faces in which two edges coincide with each other. If so, an error will be reported.
*			--------------
*
*			- Parameters :
*			--------------
...
*           The List of values that describe this anomaly are :
*
*     @param CATCGMFace_InconsistentOrientationOnSurface       :
*		------------------------------------------
*
*			- Definition : This check identifies whether the face normal and surface normals are consistent. If not, an error will be reported.
*			--------------
*
*			- Parameters :
*			--------------
...
enum CATCGMExplicitCheckAnomaly 
{
   CATCGMInternalAnomalies,
   //
   CATCGMAllSpecificAnomalies,
   //
   CATCGMVertex_GapXYZ,
   //
   CATCGMEdge_GapXYZ,
   //
   CATCGMEdge_LengthDegenerated,
   //
   CATCGMVolume_InnerShellOutsideOuterShell,   
   //
   CATCGMEdgeDomain_AutoIntersection,
   //
   CATCGMEdgeDomain_DisconnectedEdges,
   //
   CATCGMFace_InnerLoopOutsideOuterLoop,
   //
   CATCGMFace_IntersectionBetweenLoops,
   //
   CATCGMFace_IsoDegenerescence,
   //
   CATCGMFace_Twisted,
   //
   CATCGMFace_NulCurvatureRadius,
	//
	CATCGMEdge_HighNbArcs,
	//
	CATCGMEdge_HighPolynomialDegree,
	//
	CATCGMEdge_KnotsInSideRange,
	//
	CATCGMFace_HighNbPatches,
	//
	CATCGMFace_HighPolynomialDegree,
	//
	CATCGMFace_KnotsInSideRange,
	//
	CATCGMBody_NonManifoldEdges,
	//
	CATCGMBody_VertexOverBounded,
	//
	CATCGMBody_MultiDomains,
	//
	CATCGMEdge_DiscontinuityG0,
	//
	CATCGMEdge_DiscontinuityG1,
	//
	CATCGMEdge_DiscontinuityG2,
	//
	CATCGMEdgeDomain_DiscontinuityG0,
	//
	CATCGMEdgeDomain_DiscontinuityG1,
	//
	CATCGMEdgeDomain_DiscontinuityG2,
	//
	CATCGMEdge_ArcLengthDegenerated,
	//
	CATCGMVolume_WithInnerShell,
	//
	CATCGMEdge_LinearEdgeCurveWithOverSizedPolDeg,
	//
	CATCGMWire_DiscontinuityG0,
	//
	CATCGMShell_AdjacentFacesSharpAngle,
	//
	CATCGMFace_AreaDegenerated,
	//
	CATCGMLump_VolumeDegenerated,
	//
	CATCGMShell_DiscontinuityG0,
	//
	CATCGMShell_DiscontinuityG1,
	//
	CATCGMShell_DiscontinuityG2,
	//
	CATCGMFace_DiscontinuityG0,
	//
	CATCGMFace_DiscontinuityG1,
	//
	CATCGMFace_DiscontinuityG2,
	//
	CATCGMFace_PatchAreaDegenerated,
	//
	CATCGMSetOfBody_EmbeddedWireBodies,
	//
	CATCGMSetOfBody_EmbeddedSkinBodies,
	//
	CATCGMSetOfBody_EmbeddedSolidBodies,
	//
	CATCGMBody_EmbeddedFaces,
	//
	CATCGMFace_Folded,
	//
	CATCGMShell_ConfusedFreeEdges,
	//
	CATCGMFace_PatchLengthDegenerated,
	//
	CATCGMEdge_NulCurvatureRadius,
	//
	CATCGMEdgeDomain_LengthDegenerated,
	//
	CATCGMPOEC_GapXYZ,
	//
	CATCGMFace_WithAnalyticalOrProceduralSurface,
	//
	CATCGMEdge_WithAnalyticalOrProceduralCurve,
	//
	CATCGMFace_SurfaceWithHighNumberOfCtrlPoints,
	//
	CATCGMSurface_MultiFaces,
	//
	CATCGMFace_PlanarSurfaceWithOverSizedPolDeg,
    //	
	CATCGMEdgeDomain_SharpAngleOnAdjacentEdges,
	//
	CATCGMEdge_ConfusedExtremities,
	//
	CATCGMFace_DegeneratedBoundaryPatchLength,
	//
	CATCGMEdge_WavyPlanarCurve,
	//
	CATCGMFace_BigCurvatureRadius,
	//
	CATCGMFace_PatchSurfaceSharpnessAngle,
	//
	CATCGMFace_PatchSurfaceUndefinedNormal,
	//
	CATCGMSurface_UnusedPatches,
	//
	CATCGMFace_WavySurface,
	//
	CATCGMFace_SelfIntersection,
	//
	CATCGMEdgeDomain_InvalidEdgeOrientation,
	//
	CATCGMEdgeDomain_AdjacentEdgesImproperlyConnected,
	//
	CATCGMEdgeDomain_WithoutEdges,
	//
	CATCGMVertex_WithoutMacroPoint,
	//
	CATCGMBody_VertexOutsideBoundingBox,
	//
	CATCGMEdge_BoundingBoxEmpty,
	//
	CATCGMBody_IncorrectDomainType,
	//
	CATCGMBody_InvalidDomainLocation,
	//
	CATCGMBody_OverlappingEdges,
	//
	CATCGMEdge_EdgeCurveInvalid,
	//
	CATCGMPOEC_OutsideEdgeCurveMaxLimitsComplex,
	//
	CATCGMPOEC_OutsideEdgeCurveMaxLimitsHigh,
	//
	CATCGMPOEC_OutsideEdgeCurveMaxLimitsLow,
	//
	CATCGMShell_AdjacentFacesInconsistentOrientation,
	//
	CATCGMShell_NonManifoldEdge,
	//
	CATCGMVolume_FreeEdge,
	//
	CATCGMShell_WithoutFaces,
	//
	CATCGMShell_FaceOverReferenced,
	//
	CATCGMLoop_POECOutsideUFaceBoundingBox,
	//
	CATCGMLoop_POECOutsideVFaceBoundingBox,
	//
	CATCGMLoop_PCurvesOfEdgesLieOnDifferentSurfaces,
	//
	CATCGMLoop_MatterSideInvalid,
	//
	CATCGMDomain_CellsDisconnected,
	//
	CATCGMMacroPoint_WithoutPoints,
	//
	CATCGMEdge_WithoutPOEC,
	//
	CATCGMEdge_WithoutVertex,
	//
	CATCGMLump_WithoutVolumes,
	//
	CATCGMFace_WithoutLoops,
	//
	CATCGMFace_FirstLoopNotOuter,
	//
	CATCGMFace_NonFirstLoopNotInner,
	//
	CATCGMLoop_UVBoundingBoxEmpty,
	//
	CATCGMLoop_POECOutsideUBoundingBox,
	//
	CATCGMLoop_POECOutsideVBoundingBox,
	//
	CATCGMLoop_POECUVGap,
	//
	CATCGMLoop_POECOutsideMaxLimitsU,
	//
	CATCGMLoop_POECOutsideMaxLimitsV,
	//
	CATCGMDomain_MultipleOwnersInsideBody,
	//
	CATCGMPOEC_OutsidePCurveMaxLimitsComplex,
	//
	CATCGMPOEC_OutsidePCurveMaxLimitsHigh,
	//
	CATCGMPOEC_OutsidePCurveMaxLimitsLow,
	//
	CATCGMLoop_PCurveAndFaceSupportDistinct,
	//
	CATCGMPOEC_ImageOnRefCurveOutsideMaxLimitsComplex,
	//
	CATCGMPOEC_ImageOnRefCurveOutsideMaxLimitsHigh,
	//
	CATCGMPOEC_ImageOnRefCurveOutsideMaxLimitsLow,
	//
	CATCGMEdge_WrongPOECOrientation,
	//
	CATCGMEdge_CachedMaxGapIncorrect,
	//
	CATCGMBody_OverlappingVertices,
	//
	CATCGMVertexInFace_WithoutVertex,
	//
	CATCGMVertexInFace_InvalidLocation,
	//
	CATCGMVertexInVolume_WithoutVertex,
	//
	CATCGMVolume_WithoutShell,
	//
	CATCGMBody_MixedConvexityEdges,
	//
	CATCGMBody_InnerIntersectionBetweenFaces,
	//
    CATCGMEdgeDomain_InconsistentEdgeOrientation,
    //
    CATCGMFace_Closed,
    //
    CATCGMFace_InconsistentOrientationOnSurface,

	// Last one : neutral element
	CATCGMExplicitCheck_UnknownAnomaly = 9999
};

/**
* Class designed to describe a detected anomaly on a given object 
* (have a look to CATPGMExplicitCheck)
*<br>
* The CATPGMExplicitReport class store usefull information which describe
...
* You cannot create, modify or delete an object of type CATPGMExplicitReport
* N.B : An anomaly has degree of severity which could be a Warning or an Error.
* 
* To use a CATPGMExplicitCheck class:
*<ul>
...
*</ul> 
*/
class ExportedByCATGMModelInterfaces CATPGMExplicitReport
{
public:
   ...
   */
   virtual void GetListOfObjectInAnomalies(CATLISTP(CATICGMObject) &ioListOfCATICGMObject) = 0;
   ...
   */
   virtual void GetAnomalyMessage(CATUnicodeString &ioAnomalyMessage) = 0;
   ...
   */
   virtual CATExplicitCheckSeverity GetSeverity() = 0;
   ...
   *   the anomaly label
   */
   virtual CATCGMExplicitCheckAnomaly GetType() const = 0;
   ...
   *     
   */
   virtual void GetListOfValues(CATListOfDouble &ioListOfValues) = 0;
   ...
   * @nodoc
   */
   virtual CATUnicodeString &GetDetailedAnomalyMessage() = 0;
   ...
   */
   virtual CATUnicodeString GetAnomalyDescription() const = 0;
   ...
   */
   virtual CATUnicodeString GetAnomalyDetailedDescription() const = 0;
   ...
   */
   virtual void GetValueInfo(CATLISTV(CATCGMCheckAnomalyValueInfo) &oValueInfos) const = 0;

   /* @nodoc */
   /**
   * Constructor
   */
   CATPGMExplicitReport();

   /* @nodoc */
   /**
   * Destructor
   */
   virtual ~CATPGMExplicitReport();
...
private:
   ...
   * Constructor
   */
	CATPGMExplicitReport(const CATPGMExplicitReport& iExplicitReport);
   
};

#endif /* CATPGMExplicitReport_h_ */
