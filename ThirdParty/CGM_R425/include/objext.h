...
//    This interface is implemented by a docclass object that can be customized
//
//-------------------------------------------------------------------------

// {61D4A8A1-2C90-11d2-ADE4-00C04F98F417}
DEFINE_GUID(IID_IDocumentSite2, 
0x61d4a8a1, 0x2c90, 0x11d2, 0xad, 0xe4, 0x0, 0xc0, 0x4f, 0x98, 0xf4, 0x17);

DECLARE_INTERFACE_(IDocumentSite2, IDocumentSite)
{
    BEGIN_INTERFACE
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
...
//-------------------------------------------------------------------------
//  SLocalRegistry2 Service
//    VBA provides this service to it's components and hosts to optimize
//    registry access and to insulate them from licensing concerns
//    This modification provides license keys back to the host to
//    allow the VBA project to be dropped.
//
//  interfaces implemented:
//    ILocalRegistry2, ILocalRegistry
//-------------------------------------------------------------------------

// { bc9313dd-2a30-4b1b-a736-eccc2a35b48d }
DEFINE_GUID(IID_ILocalRegistry2, 0xbc9313dd, 0x2a30, 0x4b1b, 0xa7, 0x36, 0xec, 0xcc, 0x2a, 0x35, 0xb4, 0x8d);
#define SID_SLocalRegistry2 IID_ILocalRegistry2

#undef  INTERFACE
#define INTERFACE  ILocalRegistry2
DECLARE_INTERFACE_(ILocalRegistry2, ILocalRegistry)
{
    BEGIN_INTERFACE
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface)(THIS_ REFIID riid, LPVOID FAR* ppvObj) PURE;
    ...
    STDMETHOD(ExtractLicense)(THIS_
    			/* [in] */ CLSID clsid,
    			/* [out] */ BSTR * pbstrLicenseKey) PURE;
    STDMETHOD(InsertLicense)(THIS_
			/* [in] */ CLSID clsid,
			/* [in] */ BSTR bstrLicenseKey) PURE;
