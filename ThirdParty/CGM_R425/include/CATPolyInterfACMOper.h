...
//===================================================================
//
// CATPolyInterfACMOper.h
//
//===================================================================
//
// Usage notes:
// Operator computing area contact model between BVHTreeSets.
// Works well on tree sets build upon Polybodies.
// DO NOT USE except for CDS-Dyn tests
//
//===================================================================

#ifndef CATPolyInterfACMOper_h
#define CATPolyInterfACMOper_h
...
class CATPolyACMInterfBuilderFactory;
 ...
 */
class ExportedByCATPolyBoundingVolumeOperators CATPolyInterfACMOper : public CATPolyInterferenceOper
{
public:
   ...
   */
  CATPolyInterfACMOper(const CATTolerance & iTol = CATGetDefaultTolerance());
  virtual ~CATPolyInterfACMOper();
   ...
   */
  virtual CATPolyACMInterfList * GetCollisions();
  ...
  /** Debug */
  virtual CATPolyInterfACMOper * CastToACMOper(){return this;}
...
private:
  ...
  CATPolyACMInterfBuilderFactory * _BuildFact;

  CATBoolean _SwapInterference;
  CATBoolean _SortInterference;
};

#endif /* CATPolyInterfACMOper_h */
