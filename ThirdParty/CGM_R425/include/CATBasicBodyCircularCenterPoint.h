/* -*-c++-*- */
#ifndef CATBasicBodyCircularCenterPoint_H
#define CATBasicBodyCircularCenterPoint_H

// COPYRIGHT DASSAULT SYSTEMES 1998
//=============================================================================
//
// CATBasicBodyCircularCenterPoint:
// Base class for implementations of the CircularCenterPoint basic CATBody
//
//=============================================================================
// Usage notes:
//
...
class ExportedByYJ000GSM CATBasicBodyCircularCenterPoint : public CATBasicBodyCircular
{
  public:

  CATBasicBodyCircularCenterPoint ( const CATGeoFactory                          *Factory,
  ...
  CATBasicBodyCircularCenterPoint( const CATGeoFactory                             *iFactory,
