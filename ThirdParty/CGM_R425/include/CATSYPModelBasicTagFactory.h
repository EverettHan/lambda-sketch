...
//===================================================================
#ifndef CATSYPModelBasicTagFactory_H
#define CATSYPModelBasicTagFactory_H
 ...
 */
class ExportedByCATStyleProcessor CATSYPModelBasicTagFactory : public CATSYPModelTagFactory
{
public:
  CATSYPModelBasicTagFactory(const CATUnicodeString& i_URI);
  virtual ~CATSYPModelBasicTagFactory();
  /**
