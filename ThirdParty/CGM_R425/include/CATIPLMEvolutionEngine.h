//===================================================================
// COPYRIGHT [!output company] 2010/06/09
//===================================================================
// CATIPLMEvolutionEngine.cpp
// Header definition of class CATIPLMEvolutionEngine
//===================================================================
//
// Usage notes:
// Use CATIPLMEvolutionEngine interface to make a new evolution of a specific set of component.
// Use it to retrieve the new components availables after the operation.
//
// @example
//  CATIPLMEvolutionEngine* pEvolutionEngine = NULL;
//  rc = CATPLMEnginesToolbox::GetEvolutionEngine( pEngine, NULL )
//
//===================================================================
//  2010/06/09 Creation: Code generated by the 3DS wizard
//===================================================================
...
#ifndef CATIPLMEvolutionEngine_H
#define CATIPLMEvolutionEngine_H
...
extern ExportedByCATPLMIntegrationInterfaces  IID IID_CATIPLMEvolutionEngine ;


class ExportedByCATPLMIntegrationInterfaces CATIPLMEvolutionEngine: public CATBaseUnknown
{
CATDeclareInterface;

public:
/** 
 * Adds an evolution datum for further treatment by the engine.
 *
 * <br><b>Role</b>: Enables to add an evolution datum in the set of data which will be treated when calling the 
 * @href CATIPLMEvolutionEngine#RunCloningOperation entry point.
 *
 * @param iComponent [in]
 *   The component asked to be cloned. Reference only.
 ...
 *   </ul>
 */
  virtual HRESULT AddEvolutionDatum( const CATPLMID & iComponent, CATIPLMAttributeSet * iAttributes ) = 0;

/**
 * Requests an evolution on a set of components.
 * <br><b>Role:</b>This method launches an evolution request on the components provided through the @href CATIPLMEvolutionEngine#AddEvolutionDatum entry point.<br>
 *
 * @return
 *   <ul>
 *   <li><tt>S_OK</tt> All have been evolved. </li> 
 *   <li><tt>E_INVALIDARG</tt> No element have been provided through the @href CATIPLMEvolutionEngine#AddEvolutionDatum entry point.</li>
...
/**
 * Iterator enabling to access to the results of the evolution operation.
 ...
 *   <li><tt>E_FAIL</tt> if the operation failed. It can be because @href CATIPLMEvolutionEngine#RunCloningOperation was not triggered.</li>
 *   </ul>
 */
  virtual HRESULT NextCloningResult( int & ioPosition, CATIPLMOperationResult *& oResult )=0;

/**
 * Gives access to a particular result of the evolution operation.
 * <br><b>Role:</b>This method enables to get some information about the result of a particular operation.<br>
 *
 * @param iComponent [in]
 *   One of the iComponent provided though the @href CATIPLMEvolutionEngine#AddEvolutionDatum entry point.
 * @param oResult  [out,CATBaseUnknown#Release]
 *   A pointer on the result descriptor.
 * <ul>
 * <li> The result is common to a versioning operation (@href CATIPLMOperationResult).</li> 
 ...
 * <br><b>Role:</b>This method enables to get an attribute set enabling to specify some attributes to use in the @href #AddEvolutionDatum entry point.<br>
 *
...
//-----------------------------------------------------------------------
CATDeclareHandler( CATIPLMEvolutionEngine, CATBaseUnknown );
