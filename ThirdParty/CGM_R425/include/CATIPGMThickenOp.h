#ifndef CATIPGMThickenOp_h_
#define CATIPGMThickenOp_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMThickenOp;
 ...
 * possibly sharing data with the input body. A CATIPGMThickenOp operator is not streamable.
 * To use it:
 *<ul>
 * <li>Create it with the <tt>CATPGMCreateThickenOp</tt> global function.
 ...
 *</ul> 
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMThickenOp: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
  ...
  /**
	 ...
	 */
  virtual void Append(const CATLISTP(CATFace) &iFaces, double iOffset1, double iOffset2 = 0.) = 0;
  ...
  /**
	 ...
	 * Internal use.
   */
  virtual void SetLimit(CATDynLimit iStartOrEnd, CATDynLimitType iType, CATGeometry *iLimit) = 0;
   ...
   * Default value for simplification is 0. (No simplification for lateral ribbon).
	 * Internal use.
   */
  virtual void SetNoSimplify() = 0;

  /**
	 * @nodoc
	 * Internal use.
	 */
  virtual void SetSurfaceForEdge(CATEdge *iEdge, CATGeometry *iSurfaceSpecification) = 0;
  ...
  */
  ...
  /**
	 ...
	 * Internal use.
	 */
  virtual void SetSoftwareConfiguration(CATSoftwareConfiguration *iNewConfig) = 0;

protected:
  /**
   * Destructor
   */
  virtual ~CATIPGMThickenOp(); // -> delete can't be called
};
...
/**
	 ...
	 */
ExportedByCATGMOperatorsInterfaces CATIPGMThickenOp *CATPGMCreateThickenOp(
