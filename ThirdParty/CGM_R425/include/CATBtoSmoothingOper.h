...
//
//====================================================================
//  Juin 2010    : ANR : Creation
// 16/07/2018    : NLD : XScale convergence operateurs topologiques
//                       plus de valeur par defaut à la tolerance de SetTolerance()
//====================================================================

#ifndef CATBtoSmoothingOper_H
#define CATBtoSmoothingOper_H
 ...
 * <br>The CATBtoSmoothingOper operator follows the global frame of the geometric operators: 
 *<ul>
 * <li>A CATBtoSmoothingOper operator is created with the <tt>CATCbtCreateWireSmoothing</tt> global method 
...
class ExportedByCATBtoSmoothing CATBtoSmoothingOper: public CATCGMVirtual
{
  CATCGMVirtualDeclareClass(CATBtoSmoothingOper);
public :
  
  virtual ~CATBtoSmoothingOper (); 
...
protected :  
  ...
  */
  CATBtoSmoothingOper (CATGeoFactory * iFactory, CATSoftwareConfiguration * iConfig); 

  CATBtoSmoothingOper (CATGeoFactory * iFactory, CATTopData* iTopData);
...
CATBtoSmoothingOper * CATBtoCreateSmoothingOper (CATGeoFactory         * iFactory, 
