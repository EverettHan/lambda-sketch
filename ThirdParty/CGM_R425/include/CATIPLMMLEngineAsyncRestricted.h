...
#ifndef CATIPLMMLEngineAsyncRestricted_H
#define CATIPLMMLEngineAsyncRestricted_H
...
extern ExportedByCATPLMModelerLanguage IID IID_CATIPLMMLEngineAsyncRestricted;
#else
extern "C" const IID IID_CATIPLMMLEngineAsyncRestricted ;
#endif

class ExportedByCATPLMModelerLanguage CATIPLMMLEngineAsyncRestricted : public CATBaseUnknown
{
  CATDeclareInterface;
public:
...
CATDeclareHandler( CATIPLMMLEngineAsyncRestricted, CATBaseUnknown );
