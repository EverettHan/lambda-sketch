#ifndef CATIPGMTopPositionPtFaceOperator_h_
#define CATIPGMTopPositionPtFaceOperator_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopPositionPtFaceOperator;

/**
 * Class defining the operator that tests the position of a 2D point with respect to a face.
 * The CATIPGMTopPositionPtFaceOperator operator follows the global frame of the topological operators:
 *<ul>
 * <li>It is created with the <tt>CATPGMCreatePositionPtFaceOperator</tt> global function:
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopPositionPtFaceOperator: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopPositionPtFaceOperator();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopPositionPtFaceOperator(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopPositionPtFaceOperator *CATPGMCreateTopPositionPtFaceOperator(
...
#endif /* CATIPGMTopPositionPtFaceOperator_h_ */
