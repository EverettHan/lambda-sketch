#ifndef CATIPGMBuildExplicitShellSurfaceTopOper_h_
#define CATIPGMBuildExplicitShellSurfaceTopOper_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMBuildExplicitShellSurfaceTopOper;
...
* <ul>
*     <li> A <tt>CATIPGMBuildExplicitShellSurfaceTopOper</tt> operator is created with the <tt>CATPGMCreateBuildExplicitShellSurfaceTopOper</tt> global function.
...
* </ul>
*/
class ExportedByCATGMOperatorsInterfaces CATIPGMBuildExplicitShellSurfaceTopOper: public CATIPGMImplicitTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMBuildExplicitShellSurfaceTopOper();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMBuildExplicitShellSurfaceTopOper(); // -> delete can't be called
};

/**
 * Creates a CATIPGMBuildExplicitShellSurfaceTopOper operator
 * @param iFactory
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMBuildExplicitShellSurfaceTopOper *CATPGMCreateBuildExplicitShellSurfaceTopOper(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATBody *iBodyWithCavityToLattice);

#endif /* CATIPGMBuildExplicitShellSurfaceTopOper_h_ */
