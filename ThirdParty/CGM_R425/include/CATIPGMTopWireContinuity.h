#ifndef CATIPGMTopWireContinuity_h_
#define CATIPGMTopWireContinuity_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopWireContinuity;

/**
 *=============================================================================
 *
 * CATIPGMTopWireContinuity
 * -----------------
 ...
 *<ul>
 * <li>A <tt>CATIPGMTopWireContinuity</tt> operator is created with the <ttCATCreateTopWireContinuity</tt> global function:
 ...
 *</ul>
*/
class ExportedByCATGMOperatorsInterfaces CATIPGMTopWireContinuity: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual                    ~CATIPGMTopWireContinuity(); // -> delete can't be called
};
...
CATIPGMTopWireContinuity *CATPGMCreateTopWireContinuity(CATGeoFactory * iFactory ,
                                                        CATTopData    * iTopData ,
                                                        CATBody       * iWireBody);

#endif /* CATIPGMTopWireContinuity_h_ */
