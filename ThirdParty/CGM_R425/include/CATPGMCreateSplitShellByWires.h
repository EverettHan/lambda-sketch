#ifndef CATPGMCreateSplitShellByWires_h_
#define CATPGMCreateSplitShellByWires_h_
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopSplitShellByWires *CATPGMCreateSplitShellByWires(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATLISTP(CATBody) *iSplittingBodies,
  CATBody *iSkinBody);

#endif /* CATPGMCreateSplitShellByWires_h_ */
