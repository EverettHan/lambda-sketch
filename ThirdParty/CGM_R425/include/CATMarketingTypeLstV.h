...
#ifndef CATMarketingTypeLstV_H
#define CATMarketingTypeLstV_H
/*
...
// @c++ansi aew 2004-08-02.20:05:04 [Replace forward declaration of standard streams with iosfwd.h] 
 #include "iosfwd.h" 
#else //!_CAT_ANSI_STREAMS 
class ostream;
#endif //_CAT_ANSI_STREAMS

class CATMarketingType;
...
//
CATLISTV_DECLARE (CATMarketingType)

//
// type homonyme
//
typedef  CATLISTV(CATMarketingType)  CATMarketingTypeLstV;
*/
#endif
