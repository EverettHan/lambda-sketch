#ifndef CATSGStreamDefaultImpl_H
#define CATSGStreamDefaultImpl_H
...
class ExportedBySGComposites CATSGStreamDefaultImpl : public CATSGCompositeHost1<CATCompStream, CATSGComposite>
{
public:
    CATSGStreamDefaultImpl(CATStreamer* iStreamer);
    virtual ~CATSGStreamDefaultImpl();
    ...
    virtual CATStreamer* ViewAsCATStreamer();
...
private:
    CATSGStreamDefaultImpl(const CATSGStreamDefaultImpl&);
    CATSGStreamDefaultImpl& operator=(const CATSGStreamDefaultImpl&);
...
#endif // CATSGStreamDefaultImpl_H
