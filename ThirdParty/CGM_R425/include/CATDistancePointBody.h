...
//
//==========================================================================================
// August 2010 Creation                                    MPX
//==========================================================================================

#ifndef CATDistancePointBody_H
#define CATDistancePointBody_H
 ...
 * To use the operator:
 * <ul>
 * <li>Create it with the <code>CATCreateDistancePointBody</code> global function, giving the <code>CATBody</code> as input,
...
class ExportedByDistanceLight CATDistancePointBody : public CATTopOperator
{
  CATCGMVirtualDeclareClass(CATDistancePointBody);

public:

  /** @nodoc */
  virtual ~CATDistancePointBody();
...
public:
  ...
  */
   ...
   */
  virtual HRESULT GetNormalProjectionInfo(CATBoolean & oIsResultNormalProjection) = 0;
...
protected:
  ...
  /** @nodoc */
  CATDistancePointBody(CATGeoFactory* iFactory, CATTopData* iData);
 ...
 */
ExportedByDistanceLight CATDistancePointBody* CATCreateDistancePointBody(
  CATBody    * iBody, 
  CATTopData * iTopData);
