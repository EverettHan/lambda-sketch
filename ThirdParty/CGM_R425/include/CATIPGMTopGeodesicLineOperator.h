#ifndef CATIPGMTopGeodesicLineOperator_h_
#define CATIPGMTopGeodesicLineOperator_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopGeodesicLineOperator;
...
*<li> Create the operator with the <tt>CATPGMCreateTopGeodesicLineOperatorFromDirection</tt> global function.
...
*/
#ifdef CATIACGMR215CAA
class ExportedByCATGMOperatorsInterfaces CATIPGMTopGeodesicLineOperator: public CATIPGMTopCurveOperator
#else
class ExportedByCATGMOperatorsInterfaces CATIPGMTopGeodesicLineOperator: public CATIPGMTopOperator
#endif
{
public:
  /**
   * Constructor
   */
  CATIPGMTopGeodesicLineOperator();

protected:
  /**
   * Destructor
   */
  virtual ~CATIPGMTopGeodesicLineOperator(); // -> delete can't be called
};

/**
* Creates the CATIPGMTopGeodesicLineOperator that will create geodesic line body passing through a point in a given direction.
* @param iFactory
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMTopGeodesicLineOperator *CATPGMCreateTopGeodesicLineOperatorFromDirection(
...
#ifdef CATIACGMR215CAA
/**
* Creates the CATIPGMTopGeodesicLineOperator which builds
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMTopGeodesicLineOperator *CATPGMCreateTopGeodesicLineOperatorAngledTangentToWire(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATBody *iOriginPoint,
  CATBody *iCurve,
...
#endif /* CATIPGMTopGeodesicLineOperator_h_ */
