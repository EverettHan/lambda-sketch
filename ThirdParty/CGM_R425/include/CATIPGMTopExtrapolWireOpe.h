#ifndef CATIPGMTopExtrapolWireOpe_h_
#define CATIPGMTopExtrapolWireOpe_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopExtrapolWireOpe;
...
* <ul>
*<li> Create the operator with the <tt>CATPGMCreateTopExtrapolWireOpe</tt> global function.
...
*</ul>
*/
class ExportedByCATGMOperatorsInterfaces CATIPGMTopExtrapolWireOpe: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopExtrapolWireOpe();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopExtrapolWireOpe(); // -> delete can't be called
};

#endif /* CATIPGMTopExtrapolWireOpe_h_ */
