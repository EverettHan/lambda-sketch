#ifndef CATTopConcatenateSurOperator_h
#define CATTopConcatenateSurOperator_h
...
* you must use the CATHybAssemble operator).
...
class ExportedByBasicTopology CATTopConcatenateSurOperator : public CATTopOperator
{
  
  //-------------------------------------------------------------------
  CATCGMVirtualDeclareClass(CATTopConcatenateSurOperator);
protected:
  //-------------------------------------------------------------------
  /**
  * @nodoc
  * Constructor. Do not use. Use <tt>CATCreateTopConcatenateSurOperator</tt> to create an
  * <tt>CATTopConcatenateSurOperator</tt>.
  */
  CATTopConcatenateSurOperator(CATGeoFactory* iFactory, CATTopData* iTopData);
public:
	...
	* Destructor.
	*/
  virtual ~CATTopConcatenateSurOperator();
  ...
  */
  virtual void SetPreference ( CATFace * iReferenceFace , CATIsoParameter iIsoParameter ) = 0;
...
*/
ExportedByBasicTopology CATTopConcatenateSurOperator* 
CATCreateTopConcatenateSurOperator(CATGeoFactory* iFactory,
                                   CATTopData*    iTopData,
                                   CATBody*       iShellBody,
                                   CATCell*       iFaceCell1,
                                   CATCell*       iFaceCell2);
...
CATCreateTopConcatenateSurOperator ( CATGeoFactory     * iFactory,
                                     ...
                                     ListPOfCATFace    * iFacesListToConcatenate );
#endif
