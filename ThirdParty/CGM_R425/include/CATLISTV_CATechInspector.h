...
/* -*-c++-*- */
#ifndef CATLISTV_CATechInspector_H_
#define CATLISTV_CATechInspector_H_

// COPYRIGHT DASSAULT SYSTEMES 1999
/**
 * @collection CATLISTV(CATechInspector_var)
...
CATLISTHand_DECLARE( CATechInspector_var )
