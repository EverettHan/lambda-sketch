...
#ifndef IVTimeUtilities_H
#define IVTimeUtilities_H
...
// These services help define a unified timestamp accross APIs so that events coming from iV devices can be compared to UI events and other events from external frameworks.
  ...
  */
ExportedByIVInterfaces CATLONG64 IVGetSystemTime(); // cf equivalent for Visu : ExportedByCATVisFoundation CATLONG64 VisGetSystemTime();
