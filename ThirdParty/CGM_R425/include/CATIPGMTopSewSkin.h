#ifndef CATIPGMTopSewSkin_h_
#define CATIPGMTopSewSkin_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopSewSkin;
 ...
 *<ul>
 * <li>Create it with the <tt>CATPGMCreateSewSkin</tt> global function.
 ...
 *</ul> 
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopSewSkin: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopSewSkin(); // -> delete can't be called
};

#endif /* CATIPGMTopSewSkin_h_ */
