#ifndef CATIPGMTopSweepSkinSkinSegment_h_
#define CATIPGMTopSweepSkinSkinSegment_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopSweepSkinSkinSegment;
 ...
 * <ul>
 *<li> Create the operator with the global function @href CATPGMCreateTopSweepSkinSkinSegment 
 ...
 * Sample:
 * <pre> 
 * CATIPGMTopSweepSkinSkinSegment * pOp =  CATPGMCreateTopSweepSkinSkinSegment(factory,Skin1,Skin2,Spine);
 * pOp->Run();
 * pOp->BeginningResult();
 ...
 *</pre>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopSweepSkinSkinSegment: public CATIPGMTopMultiResult
{
public:
  /**
   * Constructor
   */
  CATIPGMTopSweepSkinSkinSegment();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopSweepSkinSkinSegment(); // -> delete can't be called
};

/**
 * Creates a CATIPGMTopSweepSkinSkinSegment operator.
 * @param iFactory
 ...
 * operator.
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopSweepSkinSkinSegment *CATPGMCreateTopSweepSkinSkinSegment(
...
#endif /* CATIPGMTopSweepSkinSkinSegment_h_ */
