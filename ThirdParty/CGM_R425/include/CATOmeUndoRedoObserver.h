...
#ifndef CATOmeUndoRedoObserver_H_
#define CATOmeUndoRedoObserver_H_
...
/**
* <b>Role</b> : CATOmeUndoRedoObserver is a class from which you must inherit to define an observer to listen to UndoRedo Engine events.
...
class ExportedByCATOme CATOmeUndoRedoObserver : public CATBaseUnknown
{
public:
  /**
  ...
  */
  virtual HRESULT ObserverUpdate(const CATOmbUndoRedoEventID iEvent,const unsigned int iSrcTransactionID,const unsigned int iTgtTransactionID) {return E_NOTIMPL;}
  /**
