#ifndef CATIPGMBodyFromLengthOnWire_h_
#define CATIPGMBodyFromLengthOnWire_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMBodyFromLengthOnWire;
...
*</ul>
*/
class ExportedByCATGMModelInterfaces CATIPGMBodyFromLengthOnWire: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMBodyFromLengthOnWire();
  ...
  * The <tt>oLocations</tt> optional list of vertices locations in 3D.
  ...
  //- ----------------------------------------
  /** @nodoc */
  virtual void SetExtrapolationMode(CATExtrapolationMode iExt = NoExtrapol) = 0;

  /** @nodoc */
  virtual void SetWire(CATWire *aNewWire) = 0;

  /** @nodoc */
  virtual void SetVertex(CATVertex *aNewVertex) = 0;

  /** @nodoc */
  virtual void SetLength(CATLength aNewDistance, CATLengthType aNewType = CATLengthType_ABSOLUTE_L) = 0;

  // the new point is on the wire or not.
  // if the point is not on the wire it return the extrapoled distance
  /** @nodoc */
  virtual CATBoolean IsOnWire(double &oExtrapolDistance) = 0;

protected:
  /**
   * Destructor
   */
  virtual ~CATIPGMBodyFromLengthOnWire(); // -> delete can't be called
};
...
//- ----------------------------------------
/**
 * Creates a CATIPGMBodyFromLengthOnWire operator.
 * @param iFactory
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMBodyFromLengthOnWire *CATPGMCreateBodyFromLengthOnWire(
...
/**
 * Creates a CATPGMBodyFromLengthOnWire operator.
 * @param iFactory
 *    The factory of the geometry. 
 * @param iTopData
 *    The pointer to the data defining the software configuration and the journal.
...
#endif /* CATIPGMBodyFromLengthOnWire_h_ */
