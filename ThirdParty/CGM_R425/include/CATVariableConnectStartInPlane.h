...
#ifndef CATVariableConnectStartInPlane_H
#define CATVariableConnectStartInPlane_H
...
#include "CATVariableConnectStartInPlane3D.h"
...
class ExportedByConnect  CATVariableConnectStartInPlane : public CATVariableConnectStartInPlane3D
{ 
public:

  //Do not use constructor directly. Use instead the appropriate method in CATCreateConnectStartInPlane.h
  CATVariableConnectStartInPlane(CATGeoFactory * iFactory,
  ...
  ~CATVariableConnectStartInPlane();
...
protected:
  ...
  void VariableInit( CATPCurve * iPcrv1,
                     const CATCrvParam &iParamOnPcrv1,
                     const CATLONG32 iPCurveOrientation1,
                     CATSurLimits &iLimit1,
                     CATPCurve * iPcrv2,
