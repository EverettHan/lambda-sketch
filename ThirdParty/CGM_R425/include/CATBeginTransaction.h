#ifndef CATBeginTransaction_h
#define CATBeginTransaction_h
...
//
//------------------------------------------------------------------------------
// Class :      CATBeginTransaction
//                 CATModelNotification
//------------------------------------------------------------------------------



class ExportedByCATVisItf CATBeginTransaction : public CATModelNotification
{
  CATDeclareClass;

  public:
    CATBeginTransaction();
    virtual ~CATBeginTransaction();
};
