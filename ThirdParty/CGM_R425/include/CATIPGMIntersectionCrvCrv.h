#ifndef CATIPGMIntersectionCrvCrv_h_
#define CATIPGMIntersectionCrvCrv_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMIntersectionCrvCrv;
 ...
 *<ul>
 *<li>The CATIPGMIntersectionCrvCrv operator is created with the <tt>CATPGMCreateIntersection</tt> method and 
 ...
 *</ul>
 */
class ExportedByCATGMModelInterfaces CATIPGMIntersectionCrvCrv: public CATIPGMOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMIntersectionCrvCrv();

  /**
 * Returns the number of isolated resulting points of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @return
 ...
 */
  ...
  /**
 * Skips to the next solution point of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 ...
 */
  ...
  /**
 * Creates the next solution point of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @return
 ...
 */
  ...
  /**
 * Creates the next solution point on curve of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @param iCurve
 ...
 */
  ...
  /** @nodoc */
  virtual CATCrvParam GetCurveParam(
    CATCurve *iCurve,
    const CATLONG32 iIndex = 0) const = 0;

  /**
 * Retrieves the parameter of the next solution point of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @param iCurve
 * The pointer to the first or second curve which are intersected. 
 * @param ioCrvParam
 * The parameter.
 ...
 */
  ...
  /**
 * Returns the number of solution curves of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @return
 ...
 */
  ...
  /**
 * Skips to the next solution curve of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 ...
 */
  ...
  /**
 * Returns the domain of the next solution curve of <tt>this</tt> CATIPGMIntersectionCrvCrv operator.
 * @param iCurve
 ...
 */
  ...
  /**
 * Creates the next solution curve of <tt>this</tt> CATIPGMIntersectionCrvCrv operator as an edge curve.
 ...
 */
  ...
  /**
 * @nodoc
 * Modifies the tolerance of a CATIPGMIntersectionCrvCrv operator.
 ...
 * CATIPGMIntersectionCrvCrv operator (<tt>ADVANCED</tt> mode).
 ...
 */
  virtual void GetFirstConfusionParam(
    CATCrvParam &Param1,
    CATCrvParam &Param2) const = 0;
 ...
 * Curve parameter of the point on Curve2.
 */
  virtual void GetSecondConfusionParam(
    CATCrvParam &Param1,
    CATCrvParam &Param2) const = 0;
 ...
 * Curve parameter of the point on Curve2.
 */
  virtual void GetBestConfusionParam(
    CATCrvParam &Param1,
    CATCrvParam &Param2) const = 0;
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMIntersectionCrvCrv(); // -> delete can't be called
};

#endif /* CATIPGMIntersectionCrvCrv_h_ */
