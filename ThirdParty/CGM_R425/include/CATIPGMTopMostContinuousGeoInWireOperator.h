#ifndef CATIPGMTopMostContinuousGeoInWireOperator_h_
#define CATIPGMTopMostContinuousGeoInWireOperator_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopMostContinuousGeoInWireOperator;
 ...
 * <ul>
 *<li> Create the operator with the <tt>CATPGMCreateTopMostContinuousGeoInWireOperator</tt>
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopMostContinuousGeoInWireOperator: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopMostContinuousGeoInWireOperator();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopMostContinuousGeoInWireOperator(); // -> delete can't be called
};
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMTopMostContinuousGeoInWireOperator *CATPGMCreateTopMostContinuousGeoInWireOperator(
...
#endif /* CATIPGMTopMostContinuousGeoInWireOperator_h_ */
