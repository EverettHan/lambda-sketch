...
//
/*
#ifndef _CATgp_Lin_HeaderFile
#define _CATgp_Lin_HeaderFile
...
ExportedBySysCascade  Handle_CATStandard_Type& CATgp_Lin_Type_();
...
public:
 ...
 // Methods PUBLIC
 // 
ExportedBySysCascade inline CATgp_Lin();
ExportedBySysCascade inline CATgp_Lin(const CATgp_Ax1& A1);
ExportedBySysCascade inline CATgp_Lin(const CATgp_Pnt& P,const CATgp_Dir& V);
ExportedBySysCascade inline   void Reverse() ;
ExportedBySysCascade inline   CATgp_Lin Reversed() const;
...
ExportedBySysCascade inline   void SetPosition(const CATgp_Ax1& A1) ;
ExportedBySysCascade inline  const CATgp_Dir& Direction() const;
ExportedBySysCascade inline  const CATgp_Pnt& Location() const;
ExportedBySysCascade inline  const CATgp_Ax1& Position() const;
ExportedBySysCascade inline   CATStandard_Real Angle(const CATgp_Lin& Other) const;
...
ExportedBySysCascade    CATStandard_Real Distance(const CATgp_Lin& Other) const;
ExportedBySysCascade inline   CATStandard_Real SquareDistance(const CATgp_Pnt& P) const;
ExportedBySysCascade inline   CATStandard_Real SquareDistance(const CATgp_Lin& Other) const;
ExportedBySysCascade inline   CATgp_Lin Normal(const CATgp_Pnt& P) const;
ExportedBySysCascade    void Mirror(const CATgp_Pnt& P) ;
ExportedBySysCascade    CATgp_Lin Mirrored(const CATgp_Pnt& P) const;
ExportedBySysCascade    void Mirror(const CATgp_Ax1& A1) ;
ExportedBySysCascade    CATgp_Lin Mirrored(const CATgp_Ax1& A1) const;
ExportedBySysCascade    void Mirror(const CATgp_Ax2& A2) ;
ExportedBySysCascade    CATgp_Lin Mirrored(const CATgp_Ax2& A2) const;
ExportedBySysCascade inline   void Rotate(const CATgp_Ax1& A1,const CATStandard_Real Ang) ;
ExportedBySysCascade inline   CATgp_Lin Rotated(const CATgp_Ax1& A1,const CATStandard_Real Ang) const;
ExportedBySysCascade inline   void Scale(const CATgp_Pnt& P,const CATStandard_Real S) ;
ExportedBySysCascade inline   CATgp_Lin Scaled(const CATgp_Pnt& P,const CATStandard_Real S) const;
ExportedBySysCascade inline   void Transform(const CATgp_Trsf& T) ;
ExportedBySysCascade inline   CATgp_Lin Transformed(const CATgp_Trsf& T) const;
ExportedBySysCascade inline   void Translate(const CATgp_Vec& V) ;
ExportedBySysCascade inline   CATgp_Lin Translated(const CATgp_Vec& V) const;
ExportedBySysCascade inline   void Translate(const CATgp_Pnt& P1,const CATgp_Pnt& P2) ;
ExportedBySysCascade inline   CATgp_Lin Translated(const CATgp_Pnt& P1,const CATgp_Pnt& P2) const;
    const CATgp_Ax1& _CSFDB_GetCATgp_Linpos() const { return pos; }
 ...
 // Type management
 //
 ExportedBySysCascade  friend Handle_CATStandard_Type& CATgp_Lin_Type_();
