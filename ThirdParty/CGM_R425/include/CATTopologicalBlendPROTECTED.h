//
// - USE THIS FILE for use of "CATTopologicalBlend" CLASS
//
// 
#ifndef CATTopologicalBlendPROTECTED_H
#define CATTopologicalBlendPROTECTED_H

#include "CATIACGMLevel.h"

//
// Apres la R17 la classe est definie ici
//
// On se protege contre une inclusion des 2 fichiers (dans du code multiniveau par exemple)
//   "#include "CATTopologicalBlend.h"
 ...
 * @nodoc 
 */
  virtual void SetSkinSupport(const CATLONG32 iSide, const CATBody * iSkin)=0;
 ...
 * @nodoc
 */
  virtual void SetTangentToSides(const CATLONG32 iSide,        const CATLONG32 iValue, const CATLONG32 iStartEnd=0) = 0;
 ...
 * @nodoc 
 */
  virtual void SetOneLimit(const CATLONG32 iIndex,const CATLONG32 iExtremity,
 ...
 * @nodoc
 */
  virtual void GetOneCouplingPoint(const CATLONG32 iIndex, CATVertex * oVertex) const = 0;
