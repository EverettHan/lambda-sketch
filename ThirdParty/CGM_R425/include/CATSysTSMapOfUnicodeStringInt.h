// CATSysTSMapOfUnicodeStringInt.h

#ifndef _CATSysTSMapOfUnicodeStringInt_h_
#define _CATSysTSMapOfUnicodeStringInt_h_
...
#define CATSYSTS_CTNR                  CATSysTSMapOfUnicodeStringInt
