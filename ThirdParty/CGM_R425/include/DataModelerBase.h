...
#ifndef  DataModelerBase_h
#define  DataModelerBase_h 
//------------------------------------------------------------------------
//
...
ExportedByCATIAEntity   int dupacq( const int &nbelt, int igrent[],
   const unsigned char &lstand, const unsigned char &lfamco,
   int igrsor[], int &ier );
...
#ifndef gimcur_h
#define gimcur_h
  ExportedByCATIAEntity int gimcur(int &oMnum, int &ier);
#endif

#ifndef giuswap_h
#define giuswap_h
  ExportedByCATIAEntity int giuswap(int &iMnum, 
                                  int &good_model,
...
#ifndef giuchg_h
#define giuchg_h
  ExportedByCATIAEntity int giuchg(int &iMnum, int &ier);
#endif

#ifndef giunum_h
#define giunum_h
  ExportedByCATIAEntity int giunum(int &oMnum, int &ier);
#endif
  ExportedByCATIAEntity void gueloc(char sbname[8], int &oMnum);
...
#ifndef gimsearch_h
#define gimsearch_h
 ExportedByCATIAEntity  int gimsearch(const char* name, int &oMnum);
#endif


#ifndef gimpath_h
#define gimpath_h
 ExportedByCATIAEntity  int gimpath(int &iMnum,const char* &pathname,
                                     int &ier);
#endif

#ifndef gimempty_h
#define gimempty_h
 ExportedByCATIAEntity  int gimempty(int &oMnum, int &ier);
#endif
...
#ifndef g7usearch_h
#define g7usearch_h
 ExportedByCATIAEntity int g7usearch(const CATIAuuid key, int &oMnum, 
                                     int &jele, int &ier);  
#endif
...
#ifndef gimcur_h
#define gimcur_h
  ExportedByCATIAEntity int gimcur(CATIAModel* &oModel, int &ier);
#endif

#ifndef giuswap_h
#define giuswap_h
  ExportedByCATIAEntity int giuswap(CATIAModel *const &iModel, 
                                  CATIAModel* &good_model,
                                  CATIAModel* &old_model,  int &ier);
#endif

#ifndef gimswap_h
#define gimswap_h
  ExportedByCATIAEntity int gimswap(CATIAModel *const &previous, 
                                  CATIAModel* &next, int &ier);
#endif

#ifndef giuchg_h
#define giuchg_h
  ExportedByCATIAEntity int giuchg(CATIAModel* const &iModel, int &ier);
#endif

#ifndef giunum_h
#define giunum_h
  ExportedByCATIAEntity int giunum(CATIAModel* &oModel, int &ier);
#endif
  ExportedByCATIAEntity void gueloc(char sbname[8], CATIAModel* &oModel);
...
#ifndef gimsearch_h
#define gimsearch_h
 ExportedByCATIAEntity  int gimsearch(const char* name, CATIAModel* &oModel);
#endif


#ifndef gimpath_h
#define gimpath_h
 ExportedByCATIAEntity  int gimpath(CATIAModel* const &iModel,const char* &pathname,
                                     int &ier);
#endif

#ifndef gimempty_h
#define gimempty_h
 ExportedByCATIAEntity  int gimempty(CATIAModel* &oModel, int &ier);
#endif
...
#ifndef g7usearch_h
#define g7usearch_h
 ExportedByCATIAEntity int g7usearch(const CATIAuuid key, CATIAModel* &oModel, 
                                     int &jele, int &ier);  
#endif
