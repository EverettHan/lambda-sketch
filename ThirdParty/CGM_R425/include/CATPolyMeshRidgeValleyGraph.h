#ifndef CATPolyMeshRidgeValleyGraph_h__
#define CATPolyMeshRidgeValleyGraph_h__

// COPYRIGHT DASSAULT SYSTEMES 2017, ALL RIGHTS RESERVED.
//===================================================================
//
// CATPolyMeshRidgeValleyGraph.h
//
//===================================================================
//
// Usage notes: a graph formed by ridges and valleys polylines. Produced by CATPolyMeshRidgeValleyGraphOperator
//
//===================================================================
...
// watershed ope
#include "CATPolyMeshDropPathOnTerrainOperator.h"
...
struct ExportedByCATPolyMeshWatershedOperators CATPolyMeshRidgeValleyGraph
{
public:
  ...
  struct CATPolyRVArcElem_t
  {
    ...
    // to be removed soon!
    CATPolyMeshRidgeValleyGraph::KindOfArcElem_t m_Kind;
  ...
  {
    CATPolyMeshDropPathOnTerrainOperator::KindOfFlow m_KindOfFlow;
...
#endif // CATPolyMeshRidgeValleyGraph_h__
