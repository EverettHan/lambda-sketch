...
//===================================================================
//
// CATPolyMathQuadSurfaceProjectOper.h
// Header definition of CATPolyMathQuadSurfaceProjectOper
//
//===================================================================
//
// Usage notes:
...
//===================================================================
//
// May 2010  Adaptation: tpg
//===================================================================
#ifndef CATPolyMathQuadSurfaceProjectOper_H
#define CATPolyMathQuadSurfaceProjectOper_H
...
class ExportedByPolyMathSurfaces CATPolyMathQuadSurfaceProjectOper
{

public:

  CATPolyMathQuadSurfaceProjectOper (const CATPolyMathQuadSurface& iPatch);

  ~CATPolyMathQuadSurfaceProjectOper();   

public: 

  // Project the point iPoint onto the Quad Surface.  The result is the point oProjectedPoint.
...
protected:
  ...
  CATLONG32 SafeNewton (const CATMathPoint& iPoint, double & x, double & y) const;
	...
	// Specific projection
  HRESULT ProjectOnPlane (const CATMathPoint& iPoint, CATMathPoint& oProjectedPoint,
                   double& u, double& v) const;

private:

  const CATPolyMathQuadSurface& _MathSurface;
