#ifndef CATIPGMInterproxCrv_h_
#define CATIPGMInterproxCrv_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMInterproxCrv;
 ...
 * <ul><li>Create it with the <tt>CATPGMCreateInterproxCrv</tt> global method. The run is automatically done and the
 ...
 * <ul><li>Create it with the <tt>CATPGMCreateInterproxCrv</tt> global method.
 ...
 * </ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMInterproxCrv: public CATIPGMVirtual
{
public:
  /**
   * Constructor
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMInterproxCrv(); // -> delete can't be called
};

#endif /* CATIPGMInterproxCrv_h_ */
