/* -*-C++-*-*/
#ifndef CATPolyhedralORMIsoSurface_H
#define CATPolyhedralORMIsoSurface_H

//=============================================================================
//
// COPYRIGHT : DASSAULT SYSTEMES 2022
//
// CATGMPolyhedralORMIsoSurface
//
// DESCRIPTION :
// Operator that generate an IsoSurface from a volumic OrmModel and a density
//
//
// History
//
// August 2022 RBU3 Creation
//=============================================================================
...
* </ul>
*/
class ExportedByGMPolyORMOper CATPolyhedralORMIsoSurface : public CATGMPolyTopOperator
{
  CATCGMVirtualDeclareClass(CATPolyhedralORMIsoSurface);
...
public:
  ...
  * Destructor
  */
  virtual ~CATPolyhedralORMIsoSurface();
  ...
  //--------------------------------------------------------------------------
  virtual void SetVolumesToOptimize(const CATLISTP(CATCell) &iListVolumeToOptimize) = 0;
  ...
  //--------------------------------------------------------------------------
  virtual void SetMergeOfIsoNodes(CATBoolean iActivateMerging, double *iTol = NULL) = 0;
...
protected:
  ...
  */
  CATPolyhedralORMIsoSurface(CATGeoFactory & iFactory, const CATTopData & iTopData, CATGMPolyOperTopExt &iExtensible);
...
private:
  ...
  CATPolyhedralORMIsoSurface();
  CATPolyhedralORMIsoSurface(const CATPolyhedralORMIsoSurface& iOneOf);
  CATPolyhedralORMIsoSurface& operator =(const CATPolyhedralORMIsoSurface& iOneOf);
};


/**
 * Creates a CATPolyhedralORMIsoSurface operator
 ...
 */
ExportedByGMPolyORMOper CATPolyhedralORMIsoSurface * CATCreatePolyhedralORMIsoSurface(CATGeoFactory * iFactory,
  CATTopData * iTopData, CATCGMOrmModel * iOrmModel);

#endif /* CATPolyhedralORMIsoSurface_H */
