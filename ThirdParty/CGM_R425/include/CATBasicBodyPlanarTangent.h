/* -*-c++-*- */
#ifndef CATBasicBodyPlanarTangent_H
#define CATBasicBodyPlanarTangent_H

// COPYRIGHT DASSAULT SYSTEMES 1998
//=============================================================================
//
// CATBasicBodyPlanarTangent:
// Base class for implementations of the PlanarTangent basic CATBody
//
//=============================================================================
// Usage notes:
//
...
class ExportedByYJ000GSM CATBasicBodyPlanarTangent : public CATBasicBodyPlanar
{
  public:

  CATBasicBodyPlanarTangent( const CATGeoFactory                             *iFactory,
