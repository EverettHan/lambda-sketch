#ifndef CATPGMCreateInterproxSur_h_
#define CATPGMCreateInterproxSur_h_
 ...
 * @see CATInterproxSur
 */
ExportedByCATGMOperatorsInterfaces CATIPGMInterproxSur *CATPGMCreateInterproxSur(
...
/**
 * @deprecated V5R14 CATPGMCreateInterproxSur
 * @return [out, IUnknown#Release]
 */
ExportedByCATGMOperatorsInterfaces CATIPGMInterproxSur *CATPGMCreateInterproxSur(
  CATGeoFactory *iFactory,
...
#endif /* CATPGMCreateInterproxSur_h_ */
