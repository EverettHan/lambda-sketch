#ifndef CATPickingSubEltsInsideRender_H
#define CATPickingSubEltsInsideRender_H
...
#include "SGInfra.h"
#include "CATPickingInsideRender.h"
#include "list.h"
...
enum CATPickingSubEltsInsideMode { CATPickingSubEltsInside_All, CATPickingSubEltsInside_VisibleAndAjoining};

class ExportedBySGInfra CATPickingSubEltsInsideRender : public CATPickingInsideRender
{
	CATDeclareClass_Deprec;

public:

	CATPickingSubEltsInsideRender (const CATSupport& iSupport, const float iX, const float iY, const float iDx, const float iDy, CATPickPathList& ioPickPathList, const CATPickingSubEltsInsideMode iMode = CATPickingSubEltsInside_All);
	CATPickingSubEltsInsideRender (const CATPickingSubEltsInsideRender &);

	virtual ~CATPickingSubEltsInsideRender();
...
private :
	...
	CATPickingSubEltsInsideRender();
	CATPickingSubEltsInsideRender & operator= (const CATPickingSubEltsInsideRender &);
  ...
  void SetCurrentPath(const CATRep*);
	...
	CATPickingSubEltsInsideMode _subEltsInsideMode;
