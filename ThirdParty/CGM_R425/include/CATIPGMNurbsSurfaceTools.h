#ifndef CATIPGMNurbsSurfaceTools_h_
#define CATIPGMNurbsSurfaceTools_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMNurbsSurfaceTools;

/**
 * Class used to manipulate a Nurbs surface. 
 */
class ExportedByCATGMModelInterfaces CATIPGMNurbsSurfaceTools: public CATIPGMGeoOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMNurbsSurfaceTools();
 ...
 */
  virtual CATNurbsToolsInfo SetTolKnotConfusion(
    const double iTolKnotConfusion = 0.) = 0;
 ...
 * This method deforms the surface. Use @href CATIPGMNurbsSurfaceTools#GetDeformation to compute this deformation.
 * @param iKnotRank
 ...
 * This method deform the Surface. Use @href CATIPGMNurbsSurfaceTools#GetDeformation to compute this deformation
 ...
 * Use @href CATIPGMNurbsSurfaceTools#GetDeformation to compute this deformation.
 * @param iKnotRank
 * The rank of the knot to be removed. The rank starts from 1.
 * @param iMultiplicity
 ...
 * </dl>
 * If an error has occurred, use @href CATIPGMNurbsSurfaceTools#GetInfo for more information.
 */
  virtual int Run() = 0;
 ...
 * Pointer is 0 if an error has occurred (use @href CATIPGMNurbsSurfaceTools#GetInfo for more information).
 */
 ...
 * It can be called several times and before @href CATIPGMNurbsSurfaceTools#Run.
 * @param oParamValueU
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMNurbsSurfaceTools(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMNurbsSurfaceTools *CATPGMCreateNurbsSurfaceTools(
  CATGeoFactory *iFactory,
  CATSoftwareConfiguration *iConfig,
  CATSurface *iSurface);

#endif /* CATIPGMNurbsSurfaceTools_h_ */
