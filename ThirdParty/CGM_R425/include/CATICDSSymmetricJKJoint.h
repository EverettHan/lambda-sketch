#ifndef CATICDSSymmetricJKJoint_H
#define CATICDSSymmetricJKJoint_H
 ...
 */
class ExportedByCDSInterface CATICDSSymmetricJKJoint : public CATICDSJoint
{
public:
  ...
  /**
   * Creates an instance of the CATICDSSymmetricJKJoint joint.
   * @param ipFactory
   ...
   */
  static CATICDSSymmetricJKJoint* Create(CATICDSFactory *ipFactory,
                                      CATICDSAxis* ipAxis1,
                                      CATICDSAxis* ipAxis2,
                                      CATICDSPlane* ipPlane);

  virtual ~CATICDSSymmetricJKJoint() {}
};
