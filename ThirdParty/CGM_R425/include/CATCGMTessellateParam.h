...
public:
   ...
   * @param iMaxDeviation
   *   The maximum chord deviation (sag) to be met by the tessellated body.
   *   The Value of the sag have to be greater than the resolution.
   */
   ...
   *   The Value of the step have to be greater than the resolution.
   */
   ...
   *   The Value of the angle have to be between CATPI * 0.0625 and CATPI * 0.5.
   */
