#ifndef CATPGMHLRBodySubEdgeIterator_h
#define CATPGMHLRBodySubEdgeIterator_h
 ...
 */
class ExportedByCATGMOperatorsInterfaces CATPGMHLRBodySubEdgeIterator : public CATHLRBodySubEdgeIterator
{
