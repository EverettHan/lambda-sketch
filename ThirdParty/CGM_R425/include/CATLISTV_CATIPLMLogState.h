/* -*-c++-*- */
#ifndef CATLISTV_CATIPLMLogState_H
#define CATLISTV_CATIPLMLogState_H
/* -*-c++-*- */
...
CATLISTV_DECLARE( CATIPLMLogState_var )

typedef CATLISTV( CATIPLMLogState_var ) CATIPLMLogStates;
