...
int CATListPtr##N::Compare_s  ( const CATListPtr##N& iL1,                               \
                              const CATListPtr##N& iL2,                                 \
                              int (*iPFCompare)( T*, T*) )                              \
{                                                                                       \
  if ( &iL1 == &iL2 ) return  0 ;                                                       \
  ...
  int test ;                                                                            \
  for ( int i = 0  ;  i < iL1._Size  ; i++ ) {                                          \
    test = (*iPFCompare)( iL1._Block[i], iL2._Block[i] );                               \
    if ( test != 0 ) return test ;                                                      \
  }                                                                                     \
  return 0 ;                                                                            \
}
...
void CATListPtr##N::QuickSort_s ( int (*iPFCompare)( T**, T** ) )                       \
{                                                                                       \
  qsort ( _Block, _Size, sizeof(void*), (int (*)(const void *,const void *))iPFCompare );\
}
#endif
