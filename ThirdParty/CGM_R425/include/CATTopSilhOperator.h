#ifndef CATTopSilhOperator_H
#define CATTopSilhOperator_H

// COPYRIGHT DASSAULT SYSTEMES  2015

#include "CATTopOperator.h"         // derivation
#include "BOTOPOPE.h"               // exportation
...
*<ul>
* <li>CATTopSilhOperator is created with the CATCreateTopSilhouette global function. 
...
* geometric factory.
*</ul>
* @see CATCreateTopSilhouette in CATTopSilhouette.h for the instanciation
 * -----------------------------------------------------------------------------------
 * July. 15     Creation DPS
 * -----------------------------------------------------------------------------------
*/

class ExportedByBOTOPOPE CATTopSilhOperator : public CATTopOperator
{

public:

  CATCGMVirtualDeclareClass(CATTopSilhOperator);

  // Destructor
  virtual ~CATTopSilhOperator();
  ...
  * @return
  */
  virtual void SetProjectionScreenForShadows(CATBody * iScreenBody, CATBoolean iLightSourceInFront, CATBoolean iFillHoles = FALSE)=0;
  ...
  * @return
  */
  virtual void SetProjectionScreenForShadows(const CATMathPlane &iScreenPlane, CATBoolean iLightSourceInFront, CATBoolean iFillHoles = FALSE)=0;
  ...
  */
  ...
  /** @nodoc 
  */
  virtual void SetShadowScreen(CATBody * iScreenBody, int iOutputDim, int iViewSide=0)=0;
  ...
  // and allows the call to the "GetOutputDomainType()" function after the CATTopSilhOperator computation
  //
  /** @nodoc 
  */
  virtual void SetSilhouetteSelectionMode(int iSilhTypes, int iStoreOutputDomainTypes=0)=0;
  ...
  */
  ...
  // ----------------------------------------------------------------------------
  // Option to call after the CATTopSilhOperator compuation
  ...
  /** @nodoc 
  */
  virtual void GetOutputDomainType(CATDomain * iOutputDomain, int &oSilhDomainType)=0;
...
protected:
  ...
  */
  ...
  // Please, call CATCreateTopSilhouette() method to create an instance (see CATTopSilhouette.h)
  CATTopSilhOperator(CATGeoFactory * iFactory, CATTopData * iTopData, CATExtTopOperator *iExtensible);
