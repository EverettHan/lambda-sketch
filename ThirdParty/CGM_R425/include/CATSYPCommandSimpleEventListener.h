...
//=============================================================================
#ifndef CATSYPCommandSimpleEventListener_H
#define CATSYPCommandSimpleEventListener_H
 ...
 */
class ExportedByUIVCoreTools CATSYPCommandSimpleEventListener : public CATCommand
{
  CATDeclareClass;
  friend class CATSYPCommandSimpleEventListenerEventPathBuilder;
  friend class CATSYPCommandSimpleEventListener_ClassHandlersSupportLifecycle;
...
protected:
   ...
   * Default constructor. 
   */
  CATSYPCommandSimpleEventListener();
  /**
   * Destructor.
   */
  virtual ~CATSYPCommandSimpleEventListener();
  /**
...
private:
  CATSYPCommandSimpleEventListener (CATSYPCommandSimpleEventListener &);
  CATSYPCommandSimpleEventListener& operator=(CATSYPCommandSimpleEventListener&);
