...
//=======================================================================================
#ifndef  PLMExchangeEngine_h
#define  PLMExchangeEngine_h
 ...
 */
class ExportedByPLMExchangeModel PLMExchangeEngine : public PLMExchangeSet
{
   public:
    ...
    /**
      ...
      */
      PLMExchangeEngine( PLMExchangeBasicNode * ixFather = NULL ) ;          
    ...
    /**
      ...
      */
      PLMExchangeEngine( const PLMExchangeEngine & ixNode ) ;
    ...
    /**
      ...
      */
      PLMExchangeEngine & operator=( const PLMExchangeEngine & ixNode ) ;
    ...
    /**
      ...
      */
      ...
      // --- Member definition
      // --- * _nStatus  Global Operation status.
