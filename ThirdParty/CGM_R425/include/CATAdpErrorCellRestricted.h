...
#define AuthorizedModuleForErrorCellAccess 666

// Check no one makes a declaration to by-pass our control. 
#if _MK_MODNAME_ == AuthorizedModuleForErrorCellAccess
...
#define CATPLMIntegrationAccess		     AuthorizedModuleForErrorCellAccess
#define CATPLMIntegration			     AuthorizedModuleForErrorCellAccess
#define CATPLMCAAIntegAccess             AuthorizedModuleForErrorCellAccess
#define TSTCATAdpOpenSaveServicesOnError AuthorizedModuleForErrorCellAccess
#define TSTCATIAdpErrorImplement         AuthorizedModuleForErrorCellAccess
	    ...
	    #error Forbidden Access To CATIAdpErrorCell from a non-infrastructure module
        // Fatal error on solaris
        @error 
