#ifndef CATIPGMLayDownCrvSur_h_
#define CATIPGMLayDownCrvSur_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMLayDownCrvSur;
...
*
*/
class ExportedByCATGMModelInterfaces CATIPGMLayDownCrvSur: public CATIPGMGeoOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMLayDownCrvSur();
  ...
  */
  ...
  /**
  * @nodoc
  * Skips to the next solution curve of <tt>this</tt> CATIPGMLayDownCrvSur operator.
  ...
  */
  ...
  /**
  * @nodoc
  * Creates the next solution curve of <tt>this</tt> CATIPGMLayDownCrvSur operator.
  * @oSupport
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMLayDownCrvSur(); // -> delete can't be called
};

#endif /* CATIPGMLayDownCrvSur_h_ */
