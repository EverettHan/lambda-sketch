#ifndef CATIPGMGeoFilling_h_
#define CATIPGMGeoFilling_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMGeoFilling;

/**
 * Operator that creates a surface passing through a set of curves.
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMGeoFilling: public CATIPGMOperator
{
public:
  /**
   * Constructor
  ...
  /**
	* Adds a curve as constraint to the definition of <tt>this</tt> CATIPGMGeoFilling operator.
	* @param iCurve
  ...
  /**
	* Adds a curve on surface as constraint to the definition of <tt>this</tt> CATIPGMGeoFilling operator.
  ...
  /**
	* Adds a ponctual constraint to the definition of <tt>this</tt> CATIPGMGeoFilling operator.
	* @param iPoint
  ...
  * <dt><tt>2</tt><dd> if the constraints define more than one boundary constraint (at level5).   
  ...
  /**
	...
	* This method must be called once for a given instance of CATIPGMGeoFilling Operator.
	* @return 
  ...
  /**
	* Returns the number of incompatibilities  of <tt>this</tt> CATIPGMGeoFilling operator 
  ...
  /**
   * Skips to the next incompatibility  of <tt>this</tt> CATIPGMGeoFilling operator.
  ...
  /**
	* Returns a pointer to the resulting Nupbs surface computed by <tt>this</tt> CATIPGMGeoFilling operator.
	*/
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMGeoFilling(); // -> delete can't be called
};

/**
 * Creates a CATIPGMGeoFilling operator.
 * @param iFactory
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMGeoFilling *CATPGMCreateGeoFilling(
  CATGeoFactory *iFactory,
  CATSurface *iInitialSurface = NULL);

#endif /* CATIPGMGeoFilling_h_ */
