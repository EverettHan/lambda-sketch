#ifndef CATConfusionCrvCrv_H
#define CATConfusionCrvCrv_H

// COPYRIGHT DASSAULT SYSTEMES  1999

#include "CreateConfusionCrvCrv.h"
class CATMathSetOfPointsND;
#include "CATMathDef.h"
#include "CATGeoOperator.h"
#include "CATCreateConfusionCrvCrv.h"
#include "Y30A3HGG.h"
 ...
 *<ul>
 *<li>The CATConfusionOperator is created with the @href CreateConfusionCrvCrv method and 
 ...
 *</ul>
 */
class ExportedByY30A3HGG CATConfusionCrvCrv : public CATGeoOperator
{
  CATCGMVirtualDeclareClass(CATConfusionCrvCrv);
 public:

/**
 * Destructor.
 */
  virtual ~CATConfusionCrvCrv();
/** @nodoc */
  CATConfusionCrvCrv(CATGeoFactory * iFactory);
/**
 * Returns the result of <tt>this</tt> CATConfusionCrvCrv operator.
 ...
 */
  ...
  */
   ...
   */
  virtual CATLONG32 PropagateConfusion(double & ow1, double & ow2, CATBoolean iFromMiddle = FALSE) = 0;
  /*
   * @nodoc
   */
  ...
  */
  virtual void SetParameters (const CATCrvParam & iStartParam1,
...
void MapOnECrv(CATMathSetOfPointsND * ioParamMap, 
               const CATCurve * iPCrv1, const CATEdgeCurve * iECrv1,
               const CATCurve * iPCrv2, const CATEdgeCurve * iECrv2);
