#ifndef CATPGMCreateInclusionPtSur_h_
#define CATPGMCreateInclusionPtSur_h_
...
*/
ExportedByCATGMModelInterfaces CATIPGMInclusionPtSur *CATPGMCreateInclusion(
...
#endif /* CATPGMCreateInclusionPtSur_h_ */
