...
#define _CATStandard_DomainError_HeaderFile

#include "CATStandard_Error.h"

#if !defined No_Exception && !defined No_CATStandard_DomainError
#define CATStandard_DomainError_Raise_if(CONDITION,MESSAGE) \
  if (CONDITION) CATStandard_DomainError::Raise(MESSAGE);
#else
#define CATStandard_DomainError_Raise_if(CONDITION,MESSAGE)
#endif


class CATStandard_DomainError : public CATStandard_Error {
...
/*
 ...
 ExportedBySysCascade  ~CATStandard_DomainError();

 // Type methods
 //
 ExportedBySysCascade  friend Handle_CATStandard_Type& CATStandard_DomainError_Type_();
