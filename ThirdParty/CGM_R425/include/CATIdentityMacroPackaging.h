...
#ifndef _CATIDENTITYMACROPACKAGING_H_
#define _CATIDENTITYMACROPACKAGING_H_
...
#define GenerateIdentityCardPackaging(name, macroIdent)                                           \
        class ExportedByIdentityCard macroIdent : public CATComponentPackaging { public: macroIdent (); }; \
        extern "C" ExportedByIdentityCard void* fctCreate(macroIdent) (void);                       \
        void* fctCreate(macroIdent) (void) { return (new macroIdent ()); }                        \
        macroIdent::macroIdent (void) : CATComponentPackaging(nameStr(name))
