#ifndef CATIPGMFrFTopologicalSweep_h_
#define CATIPGMFrFTopologicalSweep_h_
...
class CATFrFSweepChecker; // Not interfaced for the moment
class CATGeometry;
class CATLaw;
class CATMathAxis;
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMFrFTopologicalSweep;
 ...
 *</ul>
 *<br>
 * The CATIPGMFrFTopologicalSweep operator follows the global frame of the topological operators 
 * and satisfies the smart mechanism: 
 * the input bodies are not modified. A new resulting body is created, 
 * possibly sharing data with the input bodies.
 *<ul>
 * <li>A CATIPGMFrFTopologicalSweep operator is created with the <tt>CATPGMCreateFrFTopologicalSweep</tt> global method:
 ...
 *</ul> 
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMFrFTopologicalSweep: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
                   CATIPGMFrFTopologicalSweep             ();
 ...
 * Internal use.
 * Pointer should never be kept from pre-Run() to post-Run().
 */
 ...
 */
  virtual CATIPGMSweep2 *GetSweep2Operator                ()                                                            = 0;
 ...
 * @return [out, IUnknown#Release]
 */
  virtual CATIPGMFrFMovingFrame *GetMovingFrame           ()                                                         = 0;
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMFrFTopologicalSweep(); // -> delete can't be called
};

#endif /* CATIPGMFrFTopologicalSweep_h_ */
