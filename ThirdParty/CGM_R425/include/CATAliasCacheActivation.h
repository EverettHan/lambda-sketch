#ifndef CATAliasCacheActivation_H
#define CATAliasCacheActivation_H
...
class CATAliasCacheActivation
{

public : 
    // Activated
  inline static CATBoolean IsActivedWithVPMNav() {return TRUE;}
    
    // Desactivated
  inline static CATBoolean AssertOnFailure() {return FALSE;}
