...
//
#ifndef _CATStandard_NullValue_HeaderFile
#define _CATStandard_NullValue_HeaderFile
...
#if !defined No_Exception && !defined No_CATStandard_NullValue
#define CATStandard_NullValue_Raise_if(CONDITION,MESSAGE) \
  if (CONDITION) CATStandard_NullValue::Raise(MESSAGE);
#else
#define CATStandard_NullValue_Raise_if(CONDITION,MESSAGE)
#endif
...
class CATStandard_NullValue : public CATStandard_RangeError {

private:
//	CATStandard_NullValue();
/* 
 public :
 ...
 ExportedBySysCascade  ~CATStandard_NullValue();

 // Type methods
 //
 ExportedBySysCascade  friend Handle_CATStandard_Type& CATStandard_NullValue_Type_();
