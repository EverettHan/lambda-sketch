...
#ifndef CATHealGaps_H
#define CATHealGaps_H
 ...
 * <ul>
 *     <li> The <tt>CATHealGaps</tt> operator is created with the <tt>CATCreateHealGaps</tt> global function.
 *     <li> It is the user's responsibility to <tt>delete</tt> the operator with the usual C++ delete operator after it has been used.
 * </ul>
 */
class ExportedByCATSurfacicTopoOperators CATHealGaps : public CATTopOperator
{
  CATCGMVirtualDeclareClass(CATHealGaps);
public :
...
protected:
	CATHealGaps(CATGeoFactory *ipFactory, CATTopData *ipTopData);
