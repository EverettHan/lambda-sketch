#ifndef CATIPGMBtoSmoothingOperAdv_h_
#define CATIPGMBtoSmoothingOperAdv_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMBtoSmoothingOperAdv;

/**
 * Class defining a geometric operator that smooth a set of points to create a Bezier, B-spline or CCV  result.
 * <br>The CATIPGMBtoSmoothingOperAdv operator follows the global frame of the geometric operators: 
 *<ul>
 * <li>A CATIPGMBtoSmoothingOperAdv operator is created with the <tt>CATCbtCreateWireSmoothing</tt> global method 
 ...
 *</ul>
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMBtoSmoothingOperAdv: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMBtoSmoothingOperAdv();
  ...
  */
  virtual void SetCuttingByCurvatureAnalysis(
    const double iCurvatureVariationThreshold = 5.0,
  ...
  */
  virtual void FindCanonicalPrimitives( double iTol  ,              // = 0.05
                                        double iRmin ,              // = 1.  
                                        double iRmax ) = 0;         // = 100.
  ...
  */
  virtual void GetTangentVect(const int iRankPoint, CATMathVector &oTangentVect) = 0;
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMBtoSmoothingOperAdv(); // -> delete can't be called
};
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMBtoSmoothingOperAdv *CATPGMBtoCreateSmoothingOperAdv(
...
#endif /* CATIPGMBtoSmoothingOperAdv_h_ */
