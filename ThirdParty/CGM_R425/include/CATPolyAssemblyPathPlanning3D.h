...
//===================================================================
//
// CATPolyAssemblyPathPlanning3D.h
// Header definition of CATPolyAssemblyPathPlanning3D
//
//===================================================================
//
// Usage notes: Base class for path planning in a physical environment,
//              with a 3D trajectory
//
//===================================================================
//
...
//===================================================================
#ifndef CATPolyAssemblyPathPlanning3D_H
#define CATPolyAssemblyPathPlanning3D_H
...
/**
 * Base class for path planning in a physical environment, with a 3D trajectory
 */
class ExportedByPolyBodyBVHOperators CATPolyAssemblyPathPlanning3D : public CATPolyAssemblyPathPlanning
{
public:
  /**
   * Constructor
   ...
   */
  CATPolyAssemblyPathPlanning3D(CATBVHTreeSet & iScene, CATBVHTreeSet & iMovingModel, unsigned int iRandomSeed = 17, CATPolyUniformRandomGenerator::Type iType = CATPolyUniformRandomGenerator::AdvMathematics);
  CATPolyAssemblyPathPlanning3D( const CATPolyAssemblyPathPlanning3D& iOther );
  /** Destructor */
  ~CATPolyAssemblyPathPlanning3D();
  ...
  /** For Phoenix record */
  virtual CATPolyAssemblyPathPlanning3D * CastTo3D() {return this;}
  /** For Phoenix record */
  virtual CATPolyAssemblyPathPlanning6D * CastTo6D() {return 0;}

  virtual CATPolyAssemblyPathPlanning3D* Clone() const;
