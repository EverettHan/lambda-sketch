#ifndef CATIPGMSkinExtrapol_h_
#define CATIPGMSkinExtrapol_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMSkinExtrapol;
 ...
 * To use it:
 * <ul>
 * <li>Create it with the <tt>CATPGMCreateSkinExtrapol</tt> global function.
 ...
 *</ul> 
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMSkinExtrapol: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
 ...
 */
  ...
  /**
 * Returns a pointer to the topological journal dedicated to <tt>this</tt> CATIPGMSkinExtrapol operator.
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMSkinExtrapol(); // -> delete can't be called
};

/** @nodoc
 * @return [out, IUnknown#Release]
 */
ExportedByCATGMOperatorsInterfaces CATIPGMSkinExtrapol *CATPGMCreateSkinExtrapol(
  CATBody *iSkin,
