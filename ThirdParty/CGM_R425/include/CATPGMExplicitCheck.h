#ifndef CATPGMExplicitCheck_h_
#define CATPGMExplicitCheck_h_
...
*<br>
* The CATPGMExplicitCheck class allows you to perform an explicit check 
...
*</ul> 
*/
class ExportedByCATGMModelInterfaces CATPGMExplicitCheck
{
public:
   ...
   *   the Geo Factory that objects to be set for check belong.
	...
	*/
	CATPGMExplicitCheck(CATGeoFactory *piGeoFactory,CATSoftwareConfiguration *piSoftConfig);
...
//=========================================================================
   ...
   *    
   */
   virtual void SetContextBodies(ListPOfCATBody &iListOfContextBodies) = 0;
   ...
   */
	...
	*/
	virtual void SetParameter(CATCGMExplicitCheckAnomaly iLabelAnomaly, CATExplicitLabelParameter iExplicitLabelParam, CATBoolean iParam) = 0;
	...
	*				- Numerical values that describe the anomaly
	*/
	virtual void SetParameter(CATCGMExplicitCheckAnomaly iLabelAnomaly, CATExplicitLabelParameter iExplicitLabelParam, CATLONG32 iParam) = 0;
	...
	*				- Numerical values that describe the anomaly
	*/
	virtual void SetParameter(CATCGMExplicitCheckAnomaly iLabelAnomaly, CATExplicitLabelParameter iExplicitLabelParam, double iParam) = 0;
...
protected:
	CATGeoFactory							*_piGeoFactory;
	CATSoftwareConfiguration			*_piSoftConfig;
};

/**
* deprecated@
* Create a CATPGMExplicitCheck pointer.
*
* <br><b>Role</b>: Create a CATPGMExplicitCheck pointer.
* To delete with the usual C++ delete operator after use.
*
* @return [out, delete]
*/
ExportedByCATGMModelInterfaces CATPGMExplicitCheck *CATPGMCreateExplicitCheck();
...
* @return [out, delete]
*/
ExportedByCATGMModelInterfaces CATPGMExplicitCheck *CATPGMCreateExplicitCheck(CATGeoFactory *piGeoFactory,CATSoftwareConfiguration *piSoftConfig);
#endif /* CATPGMExplicitCheck_h_ */
