...
//===================================================================
#ifndef CATDimensionSystemCDS_H
#define CATDimensionSystemCDS_H
...
extern ExportedByPlug2DBase void* pSolver_application;

//-----------------------------------------------------------------------

enum CATDimensionSystemCDSType {CATUseDCM2D, CATUseDCM2DIfEnv, CATCGMSkmDataAct, CATCGMSkmDataActIfEnv};

class ExportedByPlug2DBase CATDimensionSystemCDS
{
public:
  // 1. Constructing and deleting a dimension_system
  CATDimensionSystemCDS(
                      ...
                      CATDimensionSystemCDSType iType = CATCGMSkmDataActIfEnv);
  virtual ~CATDimensionSystemCDS();

  CATICDSAdvanced* GetConstraintSolver(); // FCX 9.2005

  void ForceCDSModificationToLatestLevel(CATSoftwareConfiguration * iopSoftwareConfiguration); // FCX 06.2014
  ...
  // to set application object of CDSObjets which have been created outside the plug
  void set_application_pointer(CATICDSEntity * ipCDSobj, void* ipUserObj);
  ...
  HRESULT get_connex_component(CATICDSAdvanced* ipCS, int n_geom, g_node ** iNonCuttingElements, CATListPV & oListOfConnexGeometries, CATListPV & oListOfConnexConstraints);

  // Get the variable associated to several dimensional distance (for equal length distances)
  v_node* add_distance_equality(CATICDSAdvanced* ipCS, void* ad, int ndist, d_node** dn, int nrad, r_node** rn);
...
private:
  CATDimensionSystemCDS(const CATDimensionSystemCDS&);
  void operator=(const CATDimensionSystemCDS&);

  CATICDSAdvanced *_Solver;
