#ifndef CATICGMTopSweepVolume_h_
#define CATICGMTopSweepVolume_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATICGMTopSweepVolume;
 ...
 * </ul>
 */
class ExportedByCATGMOperatorsInterfaces CATICGMTopSweepVolume: public CATICGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATICGMTopSweepVolume();

protected:
  /**
   * Destructor
   */
  virtual ~CATICGMTopSweepVolume(); // -> delete can't be called
};
...
*/
ExportedByCATGMOperatorsInterfaces CATICGMTopSweepVolume *CATCGMCreateTopSweepVolume(
...
#endif /* CATICGMTopSweepVolume_h_ */
