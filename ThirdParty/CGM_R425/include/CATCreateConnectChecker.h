#ifndef CATCreateConnectChecker_H
#define CATCreateConnectChecker_H

#include "Y300IINT.h"
#include "CATCGMOperator.h"

class CATConnectCheckerInterfaceOfCurves;
class CATConnectCheckerInterfaceOfSurfaces;
class CATConnectCheckerInterfaceOfCurveSurface;
class CATGeoFactory;
 ...
 */
ExportedByY300IINT
CATConnectCheckerInterfaceOfCurves * CATCreateConnectChecker(CATGeoFactory *iFactory,
 ...
 */
ExportedByY300IINT
CATConnectCheckerInterfaceOfSurfaces * CATCreateConnectChecker(CATGeoFactory *iFactory,
                        CATSoftwareConfiguration *iConfig,
                        ...
                        int iOriPCrv1Mat,int iOriPCrv2Mat,
                        int iOriPCrv1Face1,int iOriPCrv2Face2);
...
CATConnectCheckerInterfaceOfSurfaces * CATCreateConnectChecker (CATGeoFactory *iFactory,
                                                                ...
                                                                const CATPCurve * iPCrv1,
                                                                const CATPCurve * iPCrv2,
                                                                int iOriPCrv1VsSurf1,int iOriPCrv2VsSurf2);
...
ExportedByY300IINT
CATConnectCheckerInterfaceOfCurveSurface * CATCreateConnectChecker(CATGeoFactory *iFactory,
                                                                   CATSoftwareConfiguration *iConfig,
                                                                   CATEdgeCurve  *iEdgeCurve,
                                                                   const CATPointOnEdgeCurve * iPOECStart,
                                                                   const CATPointOnEdgeCurve * iPOECEnd,                            
