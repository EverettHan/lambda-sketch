/* -*-C++-*-*/
#ifndef CATTessPolyEdgeIter_H
#define CATTessPolyEdgeIter_H
 ...
 * </ul>
 */
class ExportedByTessAPI CATTessPolyEdgeIter: public CATTessEdgeIter
{
public:
  /**
   * @nodoc
   ...
   * Copies an iterator.
   */
  inline void Initialize(CATTessPolyEdgeIter *  iEdgeIter);
...
inline CATFace * CATTessPolyEdgeIter::GetFace(int NuFace) const
{
  CATFace * Face = NULL;
...
inline CATPCurve * CATTessPolyEdgeIter::GetPCurve(int NuFace) const
{
...
inline CATBoolean CATTessPolyEdgeIter::GetSameSens(int NuFace) const
{
...
inline int CATTessPolyEdgeIter::GetEdgeNbPts(int NuFace) const
{
  int NbPts = 0;
  if ( NuFace>=1 && NuFace<=2 ) {
...
inline void CATTessPolyEdgeIter::Initialize(CATTessPolyEdgeIter *  iEdgeIter)
{
