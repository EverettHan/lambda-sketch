#ifndef CATIPGMProjectionCrvSur_h_
#define CATIPGMProjectionCrvSur_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMProjectionCrvSur;
 ...
 *<ul>
 *<li>The CATIPGMProjectionCrvSur operator is created with the <tt>CreateProjection</tt> method and 
 ...
 *</ul>
 */
class ExportedByCATGMModelInterfaces CATIPGMProjectionCrvSur: public CATIPGMGeoOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMProjectionCrvSur();
 ...
 */
  ...
  * Not used.
  */
  virtual double GetDistance(const CATPCurve *, const CATCrvLimits *) = 0;

  /**
 * Returns the number of solution points of <tt>this</tt> CATIPGMProjectionCrvSur operator.
 * @return
 ...
 */
  ...
  /**
 * Skips to the next solution point of <tt>this</tt> CATIPGMProjectionCrvSur operator.
 ...
 */
  ...
  /**
 * Creates the next solution point of <tt>this</tt> CATIPGMProjectionCrvSur operator.
 * @return
 ...
 */
  ...
  /**
 * Returns the number of solution curves resulting of <tt>this</tt> CATIPGMProjectionCrvSur operator.
 * @return
 ...
 */
  ...
  /**
 * Skips to the next solution curve of <tt>this</tt> CATIPGMProjectionCrvSur operator.
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMProjectionCrvSur(); // -> delete can't be called
};

#endif /* CATIPGMProjectionCrvSur_h_ */
