/* -*-c++-*- */
#ifndef CATLISTV_CATPLMTypeId_H
#define CATLISTV_CATPLMTypeId_H
/* -*-c++-*- */
...
#define CATLISTV_RemoveDuplicatesCount // Added by JBB: 01122005
...
CATLISTV_DECLARE( CATPLMTypeId )

typedef CATLISTV( CATPLMTypeId ) CATPLMTypeIds;
