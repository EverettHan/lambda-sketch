#ifndef CATPGMCreatePropagationEdge_h_
#define CATPGMCreatePropagationEdge_h_
...
*/
ExportedByCATGMModelInterfaces CATIPGMTopPropagationEdge *CATPGMCreatePropagationEdge(
...
* @return
* The pointer to the created operator. Release the operator with the <tt>Release</tt> method after use.
* <ul>
...
#endif /* CATPGMCreatePropagationEdge_h_ */
