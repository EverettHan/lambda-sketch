...
//=============================================================================
#ifndef CATVidActionBase_H
#define CATVidActionBase_H
 ...
 */
class ExportedByVisuDialog CATVidActionBase : public CATBaseUnknown
{
  CATDeclareClass;
  friend class CATVidActionBaseEventPathBuilder;
  friend class CATVidActionBase_ClassHandlersSupportLifecycle;
...
private:
  CATVidActionBase (CATVidActionBase &);
  CATVidActionBase& operator=(CATVidActionBase&);
