#ifndef CATICGMObjectImplementYP001PR4_H
#define CATICGMObjectImplementYP001PR4_H
...
#ifndef CATICGMObjectImplementYP001PR4
#define CATICGMObjectImplementYP001PR4(CLASS)                            \
  \
...
{ \
  if ( TypeReference == CATGeometryType       ||\
       ...
       TypeReference == CATPointOnCurveType   ) {\
    return 1;\
  }\
  return 0;\
} \
