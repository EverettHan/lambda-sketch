/* -*-c++-*- */
#ifndef CATBasicBodyPlanarNormal_H
#define CATBasicBodyPlanarNormal_H

// COPYRIGHT DASSAULT SYSTEMES 1998
//=============================================================================
//
// CATBasicBodyPlanarNormal:
// Base class for implementations of the PlanarNormal basic CATBody
//
//=============================================================================
// Usage notes:
//
...
class ExportedByYJ000GSM CATBasicBodyPlanarNormal : public CATBasicBodyPlanar
{
  public:

  CATBasicBodyPlanarNormal( const CATGeoFactory                             *iFactory,
