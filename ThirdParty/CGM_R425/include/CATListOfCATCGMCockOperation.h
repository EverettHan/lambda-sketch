#ifndef CATListOfCATCGMCockOperation_h
#define CATListOfCATCGMCockOperation_h

// COPYRIGHT DASSAULT SYSTEMES  1999
/** 
 * @collection CATLISTP(CATCGMCockOperation)
...
CATLISTPP_DECLARE_TS( CATCGMCockOperation , 10 )
