#ifndef CATPGMCreateTopTrimOnSupport_h_
#define CATPGMCreateTopTrimOnSupport_h_
...
*/
ExportedByCATGMOperatorsInterfaces CATIPGMHybTrim *CATPGMCreateTopTrimOnSupport(
...
#endif /* CATPGMCreateTopTrimOnSupport_h_ */
