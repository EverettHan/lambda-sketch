#ifndef CATTopPConicOperator_h
#define CATTopPConicOperator_h
 ...
 * <ul>
 *<li> Create the operator with the global function <tt>CATCreateTopPConicOperator</tt>, which defines
 ...
 * <tt>CATCreateTopPConic</tt>, that directly returns the resulting body.
*/

class ExportedByBasicTopology CATTopPConicOperator : public CATTopCurveOperator
{

  //-------------------------------------------------------------------
  CATCGMVirtualDeclareClass(CATTopPConicOperator);
public:
  //-------------------------------------------------------------------

/**
* Constructor. Do not use. Use <tt>CATCreateTopPConicOperator</tt> to create an
* <tt>CATTopPConicOperator</tt>.
*/
  CATTopPConicOperator(CATGeoFactory* iFactory, CATTopData* iTopData);

  virtual ~CATTopPConicOperator();
...
*/
  ...
  // The following setting methods follow the creation of a CATTopPConicOperator,
  // (see CATCreateTopPConicOperator global function)
  //

  //-----------------------------------------
  // settings : start and end tangents + a passing point
  virtual CATLONG32 SetTgtTgtPt(const CATMathVector& iStartTangent,
                           const CATMathVector& iEndTangent,
                           CATBody* iPassingVertexBody)=0;
  
  //-----------------------------------------
  // settings : start and end tangents, parameter 
  virtual CATLONG32 SetTgtTgtPrm(const CATMathVector& iStartTangent,
                            const CATMathVector& iEndTangent,
                            double iParameter)=0;
  
  //-----------------------------------------
  // settings : intersection point of start and end tangents + parameter
  virtual CATLONG32 SetPtPrm(CATBody* iTgtInterVertexBody,
                        double iParameter)=0;
  
  //-----------------------------------------
  // settings : intersection point of start and end tangent + a passing point
  virtual CATLONG32 SetPtPt(CATBody* iTgtInterVertexBody,
                       CATBody* iPassingVertexBody)=0;
  
  //-----------------------------------------
  // settings : 5 passing points
  virtual CATLONG32 SetPtPtPt(CATBody* iPassingVertexBody1,
  ...
  virtual CATLONG32 SetPtPtTgtInd(CATBody* iPassingVertexBody1,
                             CATBody* iPassingVertexBody2,
...
ExportedByBasicTopology CATTopPConicOperator* 
CATCreateTopPConicOperator(CATGeoFactory* iFactory,
                           CATTopData* iTopData,
                           CATBody* iShellBody,
...
CATCreateTopPConic(CATGeoFactory* iFactory,
                   CATTopData* iTopData,
                   CATBody* iShellBody,
                   CATBody* iStartVertexBody,
                   CATBody* iEndVertexBody,
