...
CATOMInitializerProlog(LocalFillDictionary__##class)\
  char LocalFillDictionary__##class = CATFillDictionary::RegisterFunctionCreation(#class,OMFactoryFunct##class);\
...
CATOMInitializerProlog(LocalFillDictionary__##keyname)\
  char LocalFillDictionary__##keyname = CATFillDictionary::RegisterFunctionCreation(#keyname,OMFactoryFunct##class);\
...
CATOMInitializerProlog(LocalFillDictionary__##keyname)\
  char LocalFillDictionary__##keyname = CATFillDictionary::RegisterFunctionCreation(#keyname,MyFunction);\
CATOMInitializerEpilog(LocalFillDictionary__##keyname);
