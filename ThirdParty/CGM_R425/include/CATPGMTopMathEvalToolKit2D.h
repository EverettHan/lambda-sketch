...
#ifndef CATPGMTopMathEvalToolKit2D_H
#define CATPGMTopMathEvalToolKit2D_H
...
//=============================================================================
//
// CATPGMTopMathEvalToolKit2D : Tool Kit of services evaluating on planar topological objects,
 ...
 */ 
class ExportedByCATGMModelInterfaces CATPGMTopMathEvalToolKit2D
{
protected :
  /**
  * Constructor
  */
  CATPGMTopMathEvalToolKit2D();

public :
  /**
  * Destructor
  */
  virtual ~CATPGMTopMathEvalToolKit2D();
...
ExportedByCATGMModelInterfaces
  CATPGMTopMathEvalToolKit2D * CATPGMCreateTopMathEvalToolKit2D(CATPlane * iRefPlane, CATSoftwareConfiguration * ipConfig = NULL);
...
*/
ExportedByCATGMModelInterfaces
  CATPGMTopMathEvalToolKit2D * CATPGMCreateTopMathEvalToolKit2D(CATGeoFactory * iFactory, const CATMathPlane & iRefMathPlane, CATSoftwareConfiguration * ipConfig = NULL);
