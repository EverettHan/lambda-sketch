...
//===================================================================
//
// CATCSSymmetricIJJoint.h
// Header definition of CATCSSymmetricIJJoint
//
//===================================================================
//
// Usage notes:
...
#ifndef CATCSSymmetricIJJoint_H
#define CATCSSymmetricIJJoint_H
 ...
 */
class ExportedBySolverInterface CATCSSymmetricIJJoint : public CATCSSimpleJoint {
public:
  /**
   * Constructs an instance of the joint.
   */
  CATCSSymmetricIJJoint();

  CATCDS_DEPRECATED("28/10/2016", "Remove useless rigid sets arguments", CATCSSymmetricIJJoint(CATCSRigidSet *ipRigidSet1, CATCSRigidSet *ipRigidSet2);)

  virtual ~CATCSSymmetricIJJoint();
