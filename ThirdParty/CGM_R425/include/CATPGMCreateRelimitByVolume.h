#ifndef CATPGMCreateRelimitByVolume_h_
#define CATPGMCreateRelimitByVolume_h_
...
* can be merged.
* <p>
* The CATIPGMTopRelimitByVolume operator is created with the <tt>CATPGMCreateRelimitByVolume</tt> 
...
*/
ExportedByCATGMModelInterfaces CATIPGMTopRelimitByVolume *CATPGMCreateRelimitByVolume(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATBody *iBodyToRelimit,
  CATBody *iSolidBody);

#endif /* CATPGMCreateRelimitByVolume_h_ */
