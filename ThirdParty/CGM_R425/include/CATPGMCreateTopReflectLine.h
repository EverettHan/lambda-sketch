#ifndef CATPGMCreateTopReflectLine_h_
#define CATPGMCreateTopReflectLine_h_
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopReflectLine *CATPGMCreateTopReflectLine(
...
#endif /* CATPGMCreateTopReflectLine_h_ */
