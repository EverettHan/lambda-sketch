 ...
 */
#if defined (CATIACGMR426CAA)
class ExportedByGeometricObjects CATICGMObjectsSave : public CATBaseUnknown
{
    CATDeclareClass;
...
#if defined ( CATIACGMR426CAA ) 
// @nodoc  
enum CATICGMObjectsLoadDiagnosis
{
  LoadDiag_NoError = 0,
  LoadDiag_UnknownError = 1,
  LoadDiag_NotEnoughMemory = 2,
  LoadDiag_PolyhedralUnstream = 3
};
#endif
 ...
 *   The stream from which the factory is read.
  */
  ...
  /**
 * @nodoc
 *  Get Short enumeration of some usefull failures occuring during load attempt
 */
  CATICGMObjectsLoadDiagnosis GetDiagnosis();
#endif
...
#if defined ( CATIACGMR426CAA ) 
  CATICGMObjectsLoadDiagnosis _Diagnosis;
#endif
  //------------------------------------------------------------------------
  // Forbidden (Declared, Not Defined) : Constructor by copy  et   operator =
  //------------------------------------------------------------------------
