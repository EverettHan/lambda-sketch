...
class ExportedByUIVCoreTools CATSYPEventSubscriberEventListener : public CATEventSubscriber
{
  CATDeclareClass;
...
protected:
   ...
   * Default constructor. 
   */
  CATSYPEventSubscriberEventListener();
  /**
   * Destructor.
   */
  virtual ~CATSYPEventSubscriberEventListener();
  /**
...
private:
  CATSYPEventSubscriberEventListener (CATSYPEventSubscriberEventListener &);
  CATSYPEventSubscriberEventListener& operator=(CATSYPEventSubscriberEventListener&);
