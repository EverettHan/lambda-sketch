 ...
 */
  virtual void SetCurve( CATEdgeCurve * iCurve       ,
 ...
 */
  virtual CATPCurve * GetGeometryOnFace(CATFace        * iBoundedFace,
                                        CATSide          iSide,
 ...
 * If <tt>NULL</tt>, this is not taken into account.
 */
  virtual void SetGeometryOnFace(CATFace             * iBoundedFace,
                                 CATSide               iSide,
                                 CATPCurve           * iPCurve,
 ...
 */
  virtual void GetNextInLoop( CATSide    iSideVsFace ,
 ...
 */
  virtual void GetVertices( CATVertex ** oStartVertex,
                            CATVertex ** oEndVertex )=0;
 ...
 * If <tt>NULL</tt>, this argument is not filled out.
 */
  virtual void GetVerticesParamsOnEdgeCurve(CATCrvParam * oStartParam,
 ...
 */
  virtual CATBoolean EvalTangent( const CATCrvParam   & iParamOnEdgeCurve, 
                                        ...
                                        CATBoolean      iTgtNormalization=TRUE)=0;
 ...
 * to belong to only one shell. 
 */     
  virtual void     SetSharpness(      CATFace         * iFace1,
                                      CATFace         * iFace2,
 ...
 */
  virtual void SetJunctionStatus(CATTopData               & iTopData,
                                 CATTopJunctionEdgeStatus   iFlag   = CatTopJunction)=0;
