#ifndef CreateTrimmedBarGraphOnPartitions_H
#define CreateTrimmedBarGraphOnPartitions_H
...
namespace lattice
{
  namespace gm
  {
    ...
    {
      /**
      * @brief Wrapper of lattice::gm::CreateTrimmedBarGraph to process
      * a partitioned body. Will return the list of faces in class from the specified
      * volume with the bar graph.
      */
      HRESULT CreateTrimmedBarGraphOnPartitions(
