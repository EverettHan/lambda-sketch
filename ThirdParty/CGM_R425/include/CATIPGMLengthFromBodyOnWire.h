#ifndef CATIPGMLengthFromBodyOnWire_h_
#define CATIPGMLengthFromBodyOnWire_h_
...
extern ExportedByCATGMModelInterfaces IID IID_CATIPGMLengthFromBodyOnWire;
...
* example:
*<pre>CATIPGMLengthFromBodyOnWire * Op =  CATIPGMLengthFromBodyOnWire (factory,vertex1,vertex2); 
...
* Example:
* <pre> 
* CATIPGMLengthFromBodyOnWire * Op =  CATIPGMLengthFromBodyOnWire (factory,vertex1,vertex2); 
...
*</pre>
*/
class ExportedByCATGMModelInterfaces CATIPGMLengthFromBodyOnWire: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMLengthFromBodyOnWire();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMLengthFromBodyOnWire(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMModelInterfaces CATIPGMLengthFromBodyOnWire *CATPGMCreateLengthFromBodyOnWire(
...
#endif /* CATIPGMLengthFromBodyOnWire_h_ */
