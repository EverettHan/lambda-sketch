#ifndef CATSurfaceSimplification_H
#define CATSurfaceSimplification_H
//
 ...
 *<ul>
 * <li>A CATSurfaceSimplification operator is created with the <tt>CATSurfaceSimplification(</tt> global method:
...
class ExportedByTopSurfaceSimplification CATSurfaceSimplification: public CATTopOperator
{
  CATCGMVirtualDeclareClass(CATSurfaceSimplification);

  public:
	
	virtual ~CATSurfaceSimplification();
	 ...
	 */
	virtual	int AddImpactedFaces(ListPOfCATFace & FacesImpacted)=0; 
   ...
   */ 
	...
	virtual void SetMaxBoundDeviation( const double iMaxG0=0.001, const double iMaxG1=0.5 )=0;
   ...
   * After that the behavior of CATSurfaceSimplification still remains the same on the sets to simplify. 
   */
    virtual void SetGlobalMode()=0;


  /**
   * if possible only a simplification using CATTopSimplify is done.
  ...
  */
	...
	* if AddImpactedFaces is not called , the number of set is equal to 1 
    */
    virtual  void GetPointsOnG0Error (const int iSetNum ,CATLISTV(CATMathPoint)& ListPointsG0Error, CATListOfDouble & ListOfValuesG0Error) const=0;
	 ...
	 * if AddImpactedFaces is not called , the number of set is equal to 1 
     */
    virtual  void GetPointsOnG1Error (const int iSetNum ,CATLISTV(CATMathPoint)& ListPointsG1Error, CATListOfDouble & ListOfValuesG1Error) const=0;
	 ...
	 * if AddImpactedFaces is not called , the number of set is equal to 1 
     */
    virtual  void GetPointsOnInnerError (const int iSetNum ,CATLISTV(CATMathPoint)& ListPointsInnerError, CATListOfDouble & ListOfValuesInnerError) const=0;
  ...
  CATSurfaceSimplification(CATGeoFactory* iFactory, CATTopData* iTopData);
 ...
 */
ExportedByTopSurfaceSimplification CATSurfaceSimplification* 
CATCreateSurfaceSimplification(CATGeoFactory*     iFactory,
                        CATTopData *       iTopData,
