#ifndef CATIPGMTopologicalMatch_h_
#define CATIPGMTopologicalMatch_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopologicalMatch;
 ...
 * The CATIPGMTopologicalMatch operator can be used in two different match configurations:
 * <ul>
 ...
 *<ul>
 * A CATIPGMTopologicalMatch operator is created with the <tt>CATPGMCreateTopologicalMatch</tt> global function 
 ...
 *
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopologicalMatch: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopologicalMatch();
 ...
 */
  ...
  /** @nodoc */
  virtual void SetLongitudinalDegree(
    CATLONG32 iWireIndex,
    CATLONG32 iSkinIndex,
    CATLONG32 iDegree) = 0;

  /** @nodoc */
  virtual void SetTransversalDegree(
    CATLONG32 iWireIndex,
    CATLONG32 iSkinIndex,
    CATLONG32 iDegree) = 0;
  ...
  virtual void GetDegrees(
    CATLONG32 iWireIndex,
    CATLONG32 iSkinIndex,
    CATLONG32 &oLongiDegree,
    CATLONG32 &oTransDegree) const = 0;
 ...
 * @nodoc
 */
  virtual void SetTangentNormMode(
    CATLONG32 iSkinIndex,
    CATLONG32 iExtremity,
    CATLONG32 iMode) = 0;
 ...
 * @nodoc
 */
  virtual void SetTangentDirectionMode(
    CATLONG32 iSkinIndex,
    CATLONG32 iExtremity,
    CATLONG32 iMode) = 0;
 ...
 * @nodoc
 */
  virtual void GetExtremitiesDirections(
    CATMathDirection *oStartTangent,
 ...
 * @nodoc
 */
  virtual void SetTangentContinuity(
    CATLONG32 iSkinIndex,
 ...
 * @nodoc
 */
  virtual CATFrFTangentContinuity GetTangentContinuity(
    CATLONG32 iSkinIndex) const = 0;
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopologicalMatch(); // -> delete can't be called
};
...
#endif /* CATIPGMTopologicalMatch_h_ */
