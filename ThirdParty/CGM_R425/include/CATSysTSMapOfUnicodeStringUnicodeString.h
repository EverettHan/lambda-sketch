// CATSysTSMapOfUnicodeStringUnicodeString.h

#ifndef _CATSysTSMapOfUnicodeStringUnicodeString_h_
#define _CATSysTSMapOfUnicodeStringUnicodeString_h_
...
#define CATSYSTS_CTNR                  CATSysTSMapOfUnicodeStringUnicodeString
