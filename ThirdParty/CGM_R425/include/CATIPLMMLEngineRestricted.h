...
//===================================================================
//
//  CATIPLMMLEngineRestricted.h
//  Define  the  CATIPLMMLEngineRestricted  interface
//
//===================================================================
...
//
// ABILITY TO CREATE ML GENERATOR USING THIS SPECIFIC INTERFACE
// PROTECTED ACCESS LIMITED TO INFRA FW. APPLI SHOULD NEVER USE THAT!!!!!!!!!!!
//
/*********************************************************************************************
 *********************************************************************************************
 *********************************************************************************************
...
#ifndef CATIPLMMLEngineRestricted_H
#define CATIPLMMLEngineRestricted_H

#include "CATUnicodeString.h"               // System PublicInterfaces
#include "CATListOfCATString.h"             // System PublicInterfaces

#include "CATIPLMMLEngineBase.h"            // System PublicInterfaces
#include "CATPLMModelerLanguageRestricted.h"// CATPLMModelerLanguage ProtectedInterfaces
...
extern ExportedByCATPLMModelerLanguage IID IID_CATIPLMMLEngineRestricted;
#else
extern "C" const IID IID_CATIPLMMLEngineRestricted ;
#endif

class ExportedByCATPLMModelerLanguage CATIPLMMLEngineRestricted : public CATIPLMMLEngineBase
{
  CATDeclareInterface;
public:
  ...
  */
  virtual HRESULT Init( const CATUnicodeString& iInputString,
                        const CATPLMMLOptions& iOptions,
                        CATError* & opError ) = 0;
...
CATDeclareHandler( CATIPLMMLEngineRestricted, CATBaseUnknown );
