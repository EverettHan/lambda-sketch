#ifndef CATIPGMTopClashOperator_h_
#define CATIPGMTopClashOperator_h_
...
extern ExportedByCATGMOperatorsInterfaces IID IID_CATIPGMTopClashOperator;
 ...
 */
class ExportedByCATGMOperatorsInterfaces CATIPGMTopClashOperator: public CATIPGMTopOperator
{
public:
  /**
   * Constructor
   */
  CATIPGMTopClashOperator();
...
protected:
   ...
   * Destructor
   */
  virtual ~CATIPGMTopClashOperator(); // -> delete can't be called
};
 ...
 */
ExportedByCATGMOperatorsInterfaces CATIPGMTopClashOperator *CATPGMCreateTopClashOperator(
  CATGeoFactory *iFactory,
  CATTopData *iTopData,
  CATBody *iBody1,
  CATBody *iBody2);

#endif /* CATIPGMTopClashOperator_h_ */
