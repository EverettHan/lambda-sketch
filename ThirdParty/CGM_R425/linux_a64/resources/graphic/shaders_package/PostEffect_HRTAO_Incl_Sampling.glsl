...
// Useful sampling functions. Note that to use radinv_fl the including shader
// must define a UBO with this layout:
#define PRIME_PERM_COUNT 360
//layout(binding = your_binding_point, set = your_set) uniform primePermB
//{
//  uint val[360];
//}
//primePermBuffer;

// The contents of the UBO must be:
...
float radinv_fl(in uint n, in uint dim)
{
