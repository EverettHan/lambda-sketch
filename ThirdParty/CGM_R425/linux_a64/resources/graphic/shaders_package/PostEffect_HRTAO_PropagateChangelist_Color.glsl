...
#define     eHashMapKeys    0
#define     eHashMapContribs    1
#define     eInputCellIds  2
#define     eChangeListA 3
#define     eChangeListB  4
#define     eHeadsList  5
...
//layout(binding = eInputChangeList, set=0) uniform usampler2D outputChangeList;
...
//
//#include "propagate_changelist_common.h"
